...
package org.oep.exch.dao.hoso.service.messaging;

import com.liferay.portal.kernel.messaging.BaseMessageListener;
import com.liferay.portal.kernel.messaging.Message;

import org.oep.exch.dao.hoso.service.ClpSerializer;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			ExchFileDinhKemLocalServiceUtil.clearService();

			HoSoMotCuaLocalServiceUtil.clearService();

			HoSoTrucTuyenLocalServiceUtil.clearService();

			KetQuaHosoLocalServiceUtil.clearService();

			TrangThaiHosoLocalServiceUtil.clearService();

			UpdateHoSoTrucTuyenLocalServiceUtil.clearService();
		}
	}
}