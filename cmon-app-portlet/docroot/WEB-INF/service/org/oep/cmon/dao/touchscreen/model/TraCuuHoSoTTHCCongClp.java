...
import org.oep.cmon.dao.touchscreen.service.TraCuuHoSoTTHCCongLocalServiceUtil;
 ...
 * @author VIENPN
 */
public class TraCuuHoSoTTHCCongClp extends BaseModelImpl<TraCuuHoSoTTHCCong>
	implements TraCuuHoSoTTHCCong {
	public TraCuuHoSoTTHCCongClp() {
	}
	...
	public void persist() throws SystemException {
		if (this.isNew()) {
			TraCuuHoSoTTHCCongLocalServiceUtil.addTraCuuHoSoTTHCCong(this);
		}
		else {
			TraCuuHoSoTTHCCongLocalServiceUtil.updateTraCuuHoSoTTHCCong(this);
		}
	}

	@Override
	public TraCuuHoSoTTHCCong toEscapedModel() {
		return (TraCuuHoSoTTHCCong)Proxy.newProxyInstance(TraCuuHoSoTTHCCong.class.getClassLoader(),
			new Class[] { TraCuuHoSoTTHCCong.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		TraCuuHoSoTTHCCongClp clone = new TraCuuHoSoTTHCCongClp();
	...
	public boolean equals(Object obj) {
		...
		TraCuuHoSoTTHCCongClp traCuuHoSoTTHCCong = null;

		try {
			traCuuHoSoTTHCCong = (TraCuuHoSoTTHCCongClp)obj;
		}
