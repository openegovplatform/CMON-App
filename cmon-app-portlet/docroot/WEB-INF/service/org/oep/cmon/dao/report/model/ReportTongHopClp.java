 ...
 * @author VIENPN
 */
public class ReportTongHopClp extends BaseModelImpl<ReportTongHop>
	implements ReportTongHop {
	public ReportTongHopClp() {
	}
	...
	public ReportTongHop toEscapedModel() {
		return (ReportTongHop)Proxy.newProxyInstance(ReportTongHop.class.getClassLoader(),
			new Class[] { ReportTongHop.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		ReportTongHopClp clone = new ReportTongHopClp();
	...
	public boolean equals(Object obj) {
		...
		ReportTongHopClp reportTongHop = null;

		try {
			reportTongHop = (ReportTongHopClp)obj;
		}
