...
/**
 * The utility for the van ban huong dan local service. This utility wraps {@link org.oep.cmon.dao.dvc.service.impl.VanBanHuongDanLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @generated
 */
public class VanBanHuongDanLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link org.oep.cmon.dao.dvc.service.impl.VanBanHuongDanLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static org.oep.cmon.dao.dvc.model.VanBanHuongDan addVanBanHuongDan(
		org.oep.cmon.dao.dvc.model.VanBanHuongDan vanBanHuongDan)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addVanBanHuongDan(vanBanHuongDan);
	}
	...
	*/
	public static org.oep.cmon.dao.dvc.model.VanBanHuongDan createVanBanHuongDan(
		long id) {
		return getService().createVanBanHuongDan(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteVanBanHuongDan(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteVanBanHuongDan(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteVanBanHuongDan(
		org.oep.cmon.dao.dvc.model.VanBanHuongDan vanBanHuongDan)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteVanBanHuongDan(vanBanHuongDan);
	}
	...
	*/
	...
	public static org.oep.cmon.dao.dvc.model.VanBanHuongDan fetchVanBanHuongDan(
		long id) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchVanBanHuongDan(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.cmon.dao.dvc.model.VanBanHuongDan getVanBanHuongDan(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getVanBanHuongDan(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<org.oep.cmon.dao.dvc.model.VanBanHuongDan> getVanBanHuongDans(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getVanBanHuongDans(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getVanBanHuongDansCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getVanBanHuongDansCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.cmon.dao.dvc.model.VanBanHuongDan updateVanBanHuongDan(
		org.oep.cmon.dao.dvc.model.VanBanHuongDan vanBanHuongDan)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateVanBanHuongDan(vanBanHuongDan);
	}
	...
	*/
	public static org.oep.cmon.dao.dvc.model.VanBanHuongDan updateVanBanHuongDan(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateVanBanHuongDan(vanBanHuongDan, merge);
	}
	...
	* @return List<VanBanHuongDan>
	*/
	public static java.util.List<org.oep.cmon.dao.dvc.model.VanBanHuongDan> findByThuTucHanhChinhIdAndLoaiTaiLieuAndDaXoa(
		long thuTucHanhChinhId, long loaiTaiLieu, int status) {
		return getService()
				   .findByThuTucHanhChinhIdAndLoaiTaiLieuAndDaXoa(thuTucHanhChinhId,
			loaiTaiLieu, status);
	}
	...
	*/
	...
	public static VanBanHuongDanLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					VanBanHuongDanLocalService.class.getName());
			...
			_service = new VanBanHuongDanLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(VanBanHuongDanLocalServiceUtil.class,
				"_service");
			MethodCache.remove(VanBanHuongDanLocalService.class);
		}

		return _service;
	}

	public void setService(VanBanHuongDanLocalService service) {
		MethodCache.remove(VanBanHuongDanLocalService.class);
	...
	private static VanBanHuongDanLocalService _service;
}