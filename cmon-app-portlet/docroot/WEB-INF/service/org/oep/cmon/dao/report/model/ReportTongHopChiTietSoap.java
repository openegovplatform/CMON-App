 ...
 * @generated
 */
public class ReportTongHopChiTietSoap implements Serializable {
	public static ReportTongHopChiTietSoap toSoapModel(
		ReportTongHopChiTiet model) {
		ReportTongHopChiTietSoap soapModel = new ReportTongHopChiTietSoap();
	...
	public static ReportTongHopChiTietSoap[] toSoapModels(
		ReportTongHopChiTiet[] models) {
		ReportTongHopChiTietSoap[] soapModels = new ReportTongHopChiTietSoap[models.length];
	...
	public static ReportTongHopChiTietSoap[][] toSoapModels(
		ReportTongHopChiTiet[][] models) {
		ReportTongHopChiTietSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new ReportTongHopChiTietSoap[models.length][models[0].length];
		}
		else {
			soapModels = new ReportTongHopChiTietSoap[0][0];
		}
	...
	public static ReportTongHopChiTietSoap[] toSoapModels(
		List<ReportTongHopChiTiet> models) {
		List<ReportTongHopChiTietSoap> soapModels = new ArrayList<ReportTongHopChiTietSoap>(models.size());

		for (ReportTongHopChiTiet model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new ReportTongHopChiTietSoap[soapModels.size()]);
	}

	public ReportTongHopChiTietSoap() {
	}
	...
	public void setPrimaryKey(ReportTongHopChiTietPK pk) {
		setCOQUANQUANLYID(pk.COQUANQUANLYID);
		setNHOMTHUTUCHANHCHINHID(pk.NHOMTHUTUCHANHCHINHID);
		setTHUTUCHANHCHINHID(pk.THUTUCHANHCHINHID);
		setTHANG(pk.THANG);
		setNAM(pk.NAM);
	}
