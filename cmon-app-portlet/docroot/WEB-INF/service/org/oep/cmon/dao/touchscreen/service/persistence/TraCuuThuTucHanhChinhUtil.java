...
/**
 * The persistence utility for the tra cuu thu tuc hanh chinh service. This utility wraps {@link TraCuuThuTucHanhChinhPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class TraCuuThuTucHanhChinhUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(TraCuuThuTucHanhChinh traCuuThuTucHanhChinh) {
		getPersistence().clearCache(traCuuThuTucHanhChinh);
	}
	 ...
	 */
	public static List<TraCuuThuTucHanhChinh> findWithDynamicQuery(
	 ...
	 */
	public static TraCuuThuTucHanhChinh update(
		TraCuuThuTucHanhChinh traCuuThuTucHanhChinh, boolean merge)
		throws SystemException {
		return getPersistence().update(traCuuThuTucHanhChinh, merge);
	}
	...
	public static TraCuuThuTucHanhChinh update(
		...
		return getPersistence()
				   .update(traCuuThuTucHanhChinh, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(traCuuThuTucHanhChinh);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(traCuuThuTucHanhChinhs);
	}
	...
	*/
	public static org.oep.cmon.dao.touchscreen.model.TraCuuThuTucHanhChinh create(
		long id) {
	...
	*/
	public static org.oep.cmon.dao.touchscreen.model.TraCuuThuTucHanhChinh remove(
		long id)
	...
	public static org.oep.cmon.dao.touchscreen.model.TraCuuThuTucHanhChinh updateImpl(
		org.oep.cmon.dao.touchscreen.model.TraCuuThuTucHanhChinh traCuuThuTucHanhChinh,
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(traCuuThuTucHanhChinh, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.cmon.dao.touchscreen.model.TraCuuThuTucHanhChinh findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.oep.cmon.dao.touchscreen.NoSuchTraCuuThuTucHanhChinhException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.cmon.dao.touchscreen.model.TraCuuThuTucHanhChinh fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<org.oep.cmon.dao.touchscreen.model.TraCuuThuTucHanhChinh> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static TraCuuThuTucHanhChinhPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (TraCuuThuTucHanhChinhPersistence)PortletBeanLocatorUtil.locate(org.oep.cmon.dao.touchscreen.service.ClpSerializer.getServletContextName(),
					TraCuuThuTucHanhChinhPersistence.class.getName());

			ReferenceRegistry.registerReference(TraCuuThuTucHanhChinhUtil.class,
				"_persistence");
		}
	...
	public void setPersistence(TraCuuThuTucHanhChinhPersistence persistence) {
	...
	private static TraCuuThuTucHanhChinhPersistence _persistence;
}