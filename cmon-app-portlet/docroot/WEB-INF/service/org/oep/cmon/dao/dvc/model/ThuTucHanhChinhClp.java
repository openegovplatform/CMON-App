 ...
 * @author liemnn
 */
public class ThuTucHanhChinhClp extends BaseModelImpl<ThuTucHanhChinh>
	implements ThuTucHanhChinh {
	public ThuTucHanhChinhClp() {
	}
	...
	public void persist() throws SystemException {
		if (this.isNew()) {
			ThuTucHanhChinhLocalServiceUtil.addThuTucHanhChinh(this);
		}
		else {
			ThuTucHanhChinhLocalServiceUtil.updateThuTucHanhChinh(this);
		}
	}

	@Override
	public ThuTucHanhChinh toEscapedModel() {
		return (ThuTucHanhChinh)Proxy.newProxyInstance(ThuTucHanhChinh.class.getClassLoader(),
	...
	@Override
	public Object clone() {
		ThuTucHanhChinhClp clone = new ThuTucHanhChinhClp();
	...
	public boolean equals(Object obj) {
		...
		ThuTucHanhChinhClp thuTucHanhChinh = null;

		try {
			thuTucHanhChinh = (ThuTucHanhChinhClp)obj;
		}
