 ...
 * @author VIENPN
 */
public class ReportTongHopPK implements Comparable<ReportTongHopPK>,
	Serializable {
	...
	public ReportTongHopPK() {
	}

	public ReportTongHopPK(long COQUANQUANLYID, long NHOMTHUTUCHANHCHINHID,
		int THANG, int NAM) {
	...
	public int compareTo(ReportTongHopPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		ReportTongHopPK pk = null;

		try {
			pk = (ReportTongHopPK)obj;
		}
	...
	public int hashCode() {
		...
		String.valueOf(NHOMTHUTUCHANHCHINHID) + String.valueOf(THANG) +
