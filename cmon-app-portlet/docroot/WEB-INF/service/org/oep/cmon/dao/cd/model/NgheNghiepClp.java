 ...
 * @author LIEMNN
 */
public class NgheNghiepClp extends BaseModelImpl<NgheNghiep>
	implements NgheNghiep {
	public NgheNghiepClp() {
	}
	...
	public void persist() throws SystemException {
		if (this.isNew()) {
			NgheNghiepLocalServiceUtil.addNgheNghiep(this);
		}
		else {
			NgheNghiepLocalServiceUtil.updateNgheNghiep(this);
		}
	}

	@Override
	public NgheNghiep toEscapedModel() {
		return (NgheNghiep)Proxy.newProxyInstance(NgheNghiep.class.getClassLoader(),
			new Class[] { NgheNghiep.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		NgheNghiepClp clone = new NgheNghiepClp();
	...
	public boolean equals(Object obj) {
		...
		NgheNghiepClp ngheNghiep = null;

		try {
			ngheNghiep = (NgheNghiepClp)obj;
		}
