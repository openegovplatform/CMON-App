 ...
 * @generated
 */
public class TraCuuHoSoTTHCCongSoap implements Serializable {
	public static TraCuuHoSoTTHCCongSoap toSoapModel(TraCuuHoSoTTHCCong model) {
		TraCuuHoSoTTHCCongSoap soapModel = new TraCuuHoSoTTHCCongSoap();
	...
	public static TraCuuHoSoTTHCCongSoap[] toSoapModels(
		TraCuuHoSoTTHCCong[] models) {
		TraCuuHoSoTTHCCongSoap[] soapModels = new TraCuuHoSoTTHCCongSoap[models.length];
	...
	public static TraCuuHoSoTTHCCongSoap[][] toSoapModels(
		TraCuuHoSoTTHCCong[][] models) {
		TraCuuHoSoTTHCCongSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new TraCuuHoSoTTHCCongSoap[models.length][models[0].length];
		}
		else {
			soapModels = new TraCuuHoSoTTHCCongSoap[0][0];
		}
	...
	public static TraCuuHoSoTTHCCongSoap[] toSoapModels(
		List<TraCuuHoSoTTHCCong> models) {
		List<TraCuuHoSoTTHCCongSoap> soapModels = new ArrayList<TraCuuHoSoTTHCCongSoap>(models.size());

		for (TraCuuHoSoTTHCCong model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new TraCuuHoSoTTHCCongSoap[soapModels.size()]);
	}

	public TraCuuHoSoTTHCCongSoap() {
	}
