 ...
 * @author LIEMNN
 */
public class TrinhDoChuyenMonClp extends BaseModelImpl<TrinhDoChuyenMon>
	implements TrinhDoChuyenMon {
	public TrinhDoChuyenMonClp() {
	}
	...
	public TrinhDoChuyenMon toEscapedModel() {
		return (TrinhDoChuyenMon)Proxy.newProxyInstance(TrinhDoChuyenMon.class.getClassLoader(),
			new Class[] { TrinhDoChuyenMon.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		TrinhDoChuyenMonClp clone = new TrinhDoChuyenMonClp();
		...
		clone.setChuyenMonId(getChuyenMonId());
	...
	public boolean equals(Object obj) {
		...
		TrinhDoChuyenMonClp trinhDoChuyenMon = null;

		try {
			trinhDoChuyenMon = (TrinhDoChuyenMonClp)obj;
		}
