...
/**
 * The utility for the chuyen mon local service. This utility wraps {@link org.oep.cmon.dao.cd.service.impl.ChuyenMonLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @generated
 */
public class ChuyenMonLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link org.oep.cmon.dao.cd.service.impl.ChuyenMonLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static org.oep.cmon.dao.cd.model.ChuyenMon addChuyenMon(
		org.oep.cmon.dao.cd.model.ChuyenMon chuyenMon)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addChuyenMon(chuyenMon);
	}
	...
	*/
	public static org.oep.cmon.dao.cd.model.ChuyenMon createChuyenMon(long id) {
		return getService().createChuyenMon(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteChuyenMon(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteChuyenMon(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteChuyenMon(
		org.oep.cmon.dao.cd.model.ChuyenMon chuyenMon)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteChuyenMon(chuyenMon);
	}
	...
	*/
	...
	public static org.oep.cmon.dao.cd.model.ChuyenMon fetchChuyenMon(long id)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchChuyenMon(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.cmon.dao.cd.model.ChuyenMon getChuyenMon(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getChuyenMon(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<org.oep.cmon.dao.cd.model.ChuyenMon> getChuyenMons(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getChuyenMons(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getChuyenMonsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getChuyenMonsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.cmon.dao.cd.model.ChuyenMon updateChuyenMon(
		org.oep.cmon.dao.cd.model.ChuyenMon chuyenMon)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateChuyenMon(chuyenMon);
	}
	...
	*/
	public static org.oep.cmon.dao.cd.model.ChuyenMon updateChuyenMon(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateChuyenMon(chuyenMon, merge);
	}
	...
	*/
	public static java.util.List<org.oep.cmon.dao.cd.model.ChuyenMon> fetchListByCongDan2CCGPId(
		long congDan2CCGPId) {
		return getService().fetchListByCongDan2CCGPId(congDan2CCGPId);
	}
	...
	* @return List<ChuyenMon>
	*/
	public static java.util.List<org.oep.cmon.dao.cd.model.ChuyenMon> getChuyenMonByChaId(
		java.lang.String idUngdung, java.lang.String idCha) {
		return getService().getChuyenMonByChaId(idUngdung, idCha);
	}
	...
	*/
	public static java.util.List<org.oep.cmon.dao.cd.model.ChuyenMon> getChuyenMonByChaIdNull(
		...
		return getService().getChuyenMonByChaIdNull(idUngdung);
	}
	...
	* @return List<ChuyenMon>
	*/
	public static java.util.List<org.oep.cmon.dao.cd.model.ChuyenMon> findByMaDanhMucUngDung(
		java.lang.String maDanhMucUngDung) {
		return getService().findByMaDanhMucUngDung(maDanhMucUngDung);
	}
	...
	public static ChuyenMonLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					ChuyenMonLocalService.class.getName());
			ClassLoader portletClassLoader = (ClassLoader)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					"portletClassLoader");

			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					ChuyenMonLocalService.class.getName(), portletClassLoader);

			_service = new ChuyenMonLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(ChuyenMonLocalServiceUtil.class,
				"_service");
			MethodCache.remove(ChuyenMonLocalService.class);
		}

		return _service;
	}

	public void setService(ChuyenMonLocalService service) {
		MethodCache.remove(ChuyenMonLocalService.class);
	...
	private static ChuyenMonLocalService _service;
}