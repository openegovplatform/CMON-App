...
/**
 * The persistence utility for the chuyen mon service. This utility wraps {@link ChuyenMonPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ChuyenMonUtil {
	 ...
	 */
	public static void clearCache(ChuyenMon chuyenMon) {
		getPersistence().clearCache(chuyenMon);
	}
	 ...
	 */
	public static List<ChuyenMon> findWithDynamicQuery(
	 ...
	 */
	public static ChuyenMon update(ChuyenMon chuyenMon, boolean merge)
		throws SystemException {
		return getPersistence().update(chuyenMon, merge);
	}
	...
	public static ChuyenMon update(ChuyenMon chuyenMon, boolean merge,
		...
		return getPersistence().update(chuyenMon, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(chuyenMon);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(chuyenMons);
	}
	...
	*/
	public static org.oep.cmon.dao.cd.model.ChuyenMon create(long id) {
	...
	*/
	public static org.oep.cmon.dao.cd.model.ChuyenMon remove(long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.oep.cmon.dao.cd.NoSuchChuyenMonException {
		return getPersistence().remove(id);
	}

	public static org.oep.cmon.dao.cd.model.ChuyenMon updateImpl(
		org.oep.cmon.dao.cd.model.ChuyenMon chuyenMon, boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(chuyenMon, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.cmon.dao.cd.model.ChuyenMon findByPrimaryKey(long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.oep.cmon.dao.cd.NoSuchChuyenMonException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.cmon.dao.cd.model.ChuyenMon fetchByPrimaryKey(long id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<org.oep.cmon.dao.cd.model.ChuyenMon> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ChuyenMonPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ChuyenMonPersistence)PortletBeanLocatorUtil.locate(org.oep.cmon.dao.cd.service.ClpSerializer.getServletContextName(),
					ChuyenMonPersistence.class.getName());

			ReferenceRegistry.registerReference(ChuyenMonUtil.class,
				"_persistence");
		}
	...
	public void setPersistence(ChuyenMonPersistence persistence) {
		_persistence = persistence;

		ReferenceRegistry.registerReference(ChuyenMonUtil.class, "_persistence");
	}

	private static ChuyenMonPersistence _persistence;
}