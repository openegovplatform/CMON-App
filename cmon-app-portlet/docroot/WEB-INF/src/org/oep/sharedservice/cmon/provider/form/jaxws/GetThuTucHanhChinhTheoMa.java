...
@XmlRootElement(name = "getThuTucHanhChinhTheoMa", namespace = "http://form.provider.cmon.sharedservice.dtt.vn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getThuTucHanhChinhTheoMa", namespace = "http://form.provider.cmon.sharedservice.dtt.vn/", propOrder = {"arg0", "arg1"})

public class GetThuTucHanhChinhTheoMa {
