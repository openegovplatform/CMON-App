...
@XmlRootElement(name = "getThuTucHanhChinhTheoId", namespace = "http://form.provider.cmon.sharedservice.dtt.vn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getThuTucHanhChinhTheoId", namespace = "http://form.provider.cmon.sharedservice.dtt.vn/", propOrder = {"arg0", "arg1"})

public class GetThuTucHanhChinhTheoId {
