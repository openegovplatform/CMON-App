...
@XmlRootElement(name = "getDonViHanhChinhTheoIdResponse", namespace = "http://citizen.provider.cmon.sharedservice.dtt.vn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getDonViHanhChinhTheoIdResponse", namespace = "http://citizen.provider.cmon.sharedservice.dtt.vn/")

public class GetDonViHanhChinhTheoIdResponse {
