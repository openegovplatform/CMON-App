...
@XmlRootElement(name = "getDVHCResponse", namespace = "http://citizen.provider.cmon.sharedservice.dtt.vn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getDVHCResponse", namespace = "http://citizen.provider.cmon.sharedservice.dtt.vn/")

public class GetDVHCResponse {
