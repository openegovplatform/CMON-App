...
@XmlRootElement(name = "yeuCauPhucHoiGiayToDinhKem", namespace = "http://officer.provider.cmon.sharedservice.dtt.vn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "yeuCauPhucHoiGiayToDinhKem", namespace = "http://officer.provider.cmon.sharedservice.dtt.vn/", propOrder = {"arg0", "arg1"})

public class YeuCauPhucHoiGiayToDinhKem {
