...
@XmlRootElement(name = "getIDTTHC2GiayTo", namespace = "http://document.provider.cmon.sharedservice.dtt.vn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getIDTTHC2GiayTo", namespace = "http://document.provider.cmon.sharedservice.dtt.vn/", propOrder = {"arg0", "arg1"})

public class GetIDTTHC2GiayTo {
