...
@XmlRootElement(name = "getDanhsachDVHCResponse", namespace = "http://citizen.provider.cmon.sharedservice.dtt.vn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getDanhsachDVHCResponse", namespace = "http://citizen.provider.cmon.sharedservice.dtt.vn/")

public class GetDanhsachDVHCResponse {
