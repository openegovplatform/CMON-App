...
@XmlRootElement(name = "getThongTinTaiLieuDinhKem", namespace = "http://document.provider.cmon.sharedservice.dtt.vn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getThongTinTaiLieuDinhKem", namespace = "http://document.provider.cmon.sharedservice.dtt.vn/", propOrder = {"arg0", "arg1"})

public class GetThongTinTaiLieuDinhKem {
