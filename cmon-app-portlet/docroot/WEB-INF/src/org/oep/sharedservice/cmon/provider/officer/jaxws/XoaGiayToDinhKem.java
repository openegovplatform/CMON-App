...
@XmlRootElement(name = "xoaGiayToDinhKem", namespace = "http://officer.provider.cmon.sharedservice.dtt.vn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "xoaGiayToDinhKem", namespace = "http://officer.provider.cmon.sharedservice.dtt.vn/", propOrder = {"arg0", "arg1"})

public class XoaGiayToDinhKem {
