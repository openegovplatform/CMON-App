...
@XmlRootElement(name = "getDVHC", namespace = "http://citizen.provider.cmon.sharedservice.dtt.vn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getDVHC", namespace = "http://citizen.provider.cmon.sharedservice.dtt.vn/")

public class GetDVHC {
