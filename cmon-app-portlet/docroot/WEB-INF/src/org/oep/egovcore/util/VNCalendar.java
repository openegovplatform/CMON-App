...
* VNCalendar  class
*   
* This class is used to declare VNCalendar 
*
* 
* 
* History:
...
public class VNCalendar {
    ...
    public static final double VN_TIMEZONE = 7.0;
    
    
    /**
	  * This is fucntion jdFromDate
	  * Version: 1.0
	  *  
	  * History: 
	  *   DATE        AUTHOR      DESCRIPTION 
    ...
    /**
	  * This is fucntion SunLongitudeAA98
	  * Version: 1.0
	  *  
	  * History: 
	  *   DATE        AUTHOR      DESCRIPTION 
    ...
    /**
	  * This is fucntion getSunLongitude
	  * Version: 1.0
	  *  
	  * History: 
	  *   DATE        AUTHOR      DESCRIPTION 
	  *  ------------------------------------------------- 
	  *  3-March-2013  Nam Dinh    Create new
	  * @param int dayNumber, double timeZone
	  * @return double
	  */
    ...
    /**
	  * This is fucntion getNewMoonDay
	  * Version: 1.0
	  *  
	  * History: 
	  *   DATE        AUTHOR      DESCRIPTION 
    ...
    /**
	  * This is fucntion getLunarMonth11
	  * Version: 1.0
	  *  
	  * History: 
	  *   DATE        AUTHOR      DESCRIPTION 
    ...
    /**
	  * This is fucntion getLeapMonthOffset
	  * Version: 1.0
	  *  
	  * History: 
	  *   DATE        AUTHOR      DESCRIPTION 
    ...
    /**
	  * This is fucntion convertSolar2Lunar
	  * Version: 1.0
	  *  
	  * History: 
	  *   DATE        AUTHOR      DESCRIPTION 
	  *  ------------------------------------------------- 
	  *  3-March-2013  Nam Dinh    Create new
	  * @param int dd, int mm, int yy, double timeZone
	  * @return int[]
	  */
    ...
    /**
	  * This is fucntion convertLunar2Solar
	  * Version: 1.0
	  *  
	  * History: 
	  *   DATE        AUTHOR      DESCRIPTION 
	  *  ------------------------------------------------- 
	  *  3-March-2013  Nam Dinh    Create new
	  * @param int lunarDay, int lunarMonth, int lunarYear, int lunarLeap, double timeZone
	  * @return int[]
	  */
