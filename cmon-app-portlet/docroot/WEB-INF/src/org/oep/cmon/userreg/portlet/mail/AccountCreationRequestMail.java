...
/** 
 * This is class AccountCreationRequestMail
...
public class AccountCreationRequestMail {
	...
	/** Mail template */
	private static final String MAIL_TEMPLATE = "vn/dtt/cmon/userreg/portlet/mail/account_confirmation_mail.template";
	...
	public void send() throws IOException{
		...
		try{
            // Create mail content
            String mailContent = MailTemplateUtil.getContent("account_confirmation_mail_template", resource.openStream(), context);
