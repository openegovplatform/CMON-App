...
/**
 * This is class ThongTinThanhToanConfigurationActionImpl  
 * Version: 1.0
 *  
 * History: 
 ...
 */
public class ThongTinThanhToanConfigurationActionImpl extends DefaultConfigurationAction {
	...
	public void processAction(PortletConfig portletConfig, ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		...
		String thongTinThanhToanPrefValue = ParamUtil.getString(actionRequest, thongTinThanhToanPrefParam);
		prefs.setValue(thongTinThanhToanPrefParam, thongTinThanhToanPrefValue);
		prefs.store();
