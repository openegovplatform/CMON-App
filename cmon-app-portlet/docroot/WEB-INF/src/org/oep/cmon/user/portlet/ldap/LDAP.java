...
package org.oep.cmon.user.portlet.ldap;
...
public class LDAP {
	...
	private static final String LDAP_CONFIG_FILE = "vn/dtt/cmon/user/portlet/ldap/LDAP_Config.properties";
	...
	/**
	 * This is function check if an user exist or not (check by email)
	 * Version: 1.0
	 *  
	 * History: 
	 *   DATE        AUTHOR      DESCRIPTION 
