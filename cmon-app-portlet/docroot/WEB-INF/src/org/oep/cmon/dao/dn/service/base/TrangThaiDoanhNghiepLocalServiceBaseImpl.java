...
/**
 * The base implementation of the trang thai doanh nghiep local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.dn.service.impl.TrangThaiDoanhNghiepLocalServiceImpl}.
 * </p>
 *
 * @author Liemnn
 ...
 * @generated
 */
public abstract class TrangThaiDoanhNghiepLocalServiceBaseImpl
	implements TrangThaiDoanhNghiepLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.dn.service.TrangThaiDoanhNghiepLocalServiceUtil} to access the trang thai doanh nghiep local service.
	 */
	 ...
	 */
	public TrangThaiDoanhNghiep addTrangThaiDoanhNghiep(
		TrangThaiDoanhNghiep trangThaiDoanhNghiep) throws SystemException {
		trangThaiDoanhNghiep.setNew(true);

		trangThaiDoanhNghiep = trangThaiDoanhNghiepPersistence.update(trangThaiDoanhNghiep,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(trangThaiDoanhNghiep);
			}
	 ...
	 */
	public TrangThaiDoanhNghiep createTrangThaiDoanhNghiep(long id) {
		return trangThaiDoanhNghiepPersistence.create(id);
	}
	...
	public void deleteTrangThaiDoanhNghiep(long id)
		...
		TrangThaiDoanhNghiep trangThaiDoanhNghiep = trangThaiDoanhNghiepPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(trangThaiDoanhNghiep);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTrangThaiDoanhNghiep(
		TrangThaiDoanhNghiep trangThaiDoanhNghiep) throws SystemException {
		trangThaiDoanhNghiepPersistence.remove(trangThaiDoanhNghiep);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return trangThaiDoanhNghiepPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trangThaiDoanhNghiepPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TrangThaiDoanhNghiep fetchTrangThaiDoanhNghiep(long id)
		throws SystemException {
		return trangThaiDoanhNghiepPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrangThaiDoanhNghiep getTrangThaiDoanhNghiep(long id)
		throws PortalException, SystemException {
		return trangThaiDoanhNghiepPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trangThaiDoanhNghiepPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrangThaiDoanhNghiep> getTrangThaiDoanhNghieps(int start,
		int end) throws SystemException {
		return trangThaiDoanhNghiepPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrangThaiDoanhNghiepsCount() throws SystemException {
		return trangThaiDoanhNghiepPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrangThaiDoanhNghiep updateTrangThaiDoanhNghiep(
		TrangThaiDoanhNghiep trangThaiDoanhNghiep) throws SystemException {
		return updateTrangThaiDoanhNghiep(trangThaiDoanhNghiep, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.dn.model.TrangThaiDoanhNghiep",
			trangThaiDoanhNghiepLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.dn.model.TrangThaiDoanhNghiep");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trangThaiDoanhNghiepPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TrangThaiDoanhNghiepLocalServiceBaseImpl.class);
