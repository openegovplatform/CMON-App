...
/**
 * The base implementation of the role2 don vi bao cao local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.report.service.impl.Role2DonViBaoCaoLocalServiceImpl}.
 * </p>
 *
 * @author VIENPN
 * @see org.oep.cmon.dao.report.service.impl.Role2DonViBaoCaoLocalServiceImpl
 * @see org.oep.cmon.dao.report.service.Role2DonViBaoCaoLocalServiceUtil
 * @generated
 */
public abstract class Role2DonViBaoCaoLocalServiceBaseImpl
	implements Role2DonViBaoCaoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.report.service.Role2DonViBaoCaoLocalServiceUtil} to access the role2 don vi bao cao local service.
	 */
	 ...
	 */
	public Role2DonViBaoCao addRole2DonViBaoCao(
		Role2DonViBaoCao role2DonViBaoCao) throws SystemException {
		role2DonViBaoCao.setNew(true);

		role2DonViBaoCao = role2DonViBaoCaoPersistence.update(role2DonViBaoCao,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(role2DonViBaoCao);
			}
	 ...
	 */
	public Role2DonViBaoCao createRole2DonViBaoCao(long ID) {
		return role2DonViBaoCaoPersistence.create(ID);
	}
	...
	public void deleteRole2DonViBaoCao(long ID)
		...
		Role2DonViBaoCao role2DonViBaoCao = role2DonViBaoCaoPersistence.remove(ID);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(role2DonViBaoCao);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteRole2DonViBaoCao(Role2DonViBaoCao role2DonViBaoCao)
		throws SystemException {
		role2DonViBaoCaoPersistence.remove(role2DonViBaoCao);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return role2DonViBaoCaoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return role2DonViBaoCaoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Role2DonViBaoCao fetchRole2DonViBaoCao(long ID)
		throws SystemException {
		return role2DonViBaoCaoPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Role2DonViBaoCao getRole2DonViBaoCao(long ID)
		throws PortalException, SystemException {
		return role2DonViBaoCaoPersistence.findByPrimaryKey(ID);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return role2DonViBaoCaoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Role2DonViBaoCao> getRole2DonViBaoCaos(int start, int end)
		throws SystemException {
		return role2DonViBaoCaoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getRole2DonViBaoCaosCount() throws SystemException {
		return role2DonViBaoCaoPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Role2DonViBaoCao updateRole2DonViBaoCao(
		Role2DonViBaoCao role2DonViBaoCao) throws SystemException {
		return updateRole2DonViBaoCao(role2DonViBaoCao, true);
	}
	 ...
	 */
	public Role2DonViBaoCao updateRole2DonViBaoCao(
		Role2DonViBaoCao role2DonViBaoCao, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.report.model.Role2DonViBaoCao",
			role2DonViBaoCaoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.report.model.Role2DonViBaoCao");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = role2DonViBaoCaoPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(Role2DonViBaoCaoLocalServiceBaseImpl.class);
