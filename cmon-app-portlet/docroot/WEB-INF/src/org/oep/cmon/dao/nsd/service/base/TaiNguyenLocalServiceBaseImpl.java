...
/**
 * The base implementation of the tai nguyen local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.nsd.service.impl.TaiNguyenLocalServiceImpl}.
 * </p>
 *
 * @author Liemnn
 ...
 * @generated
 */
public abstract class TaiNguyenLocalServiceBaseImpl
	implements TaiNguyenLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.nsd.service.TaiNguyenLocalServiceUtil} to access the tai nguyen local service.
	 */
	 ...
	 */
	public TaiNguyen addTaiNguyen(TaiNguyen taiNguyen)
		throws SystemException {
		taiNguyen.setNew(true);

		taiNguyen = taiNguyenPersistence.update(taiNguyen, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(taiNguyen);
			}
	 ...
	 */
	public TaiNguyen createTaiNguyen(long id) {
		return taiNguyenPersistence.create(id);
	}
	...
	public void deleteTaiNguyen(long id)
		...
		TaiNguyen taiNguyen = taiNguyenPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(taiNguyen);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteTaiNguyen(TaiNguyen taiNguyen) throws SystemException {
		taiNguyenPersistence.remove(taiNguyen);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return taiNguyenPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return taiNguyenPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return taiNguyenPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TaiNguyen fetchTaiNguyen(long id) throws SystemException {
		return taiNguyenPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TaiNguyen getTaiNguyen(long id)
		throws PortalException, SystemException {
		return taiNguyenPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return taiNguyenPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TaiNguyen> getTaiNguyens(int start, int end)
		throws SystemException {
		return taiNguyenPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTaiNguyensCount() throws SystemException {
		return taiNguyenPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TaiNguyen updateTaiNguyen(TaiNguyen taiNguyen)
		throws SystemException {
		return updateTaiNguyen(taiNguyen, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TaiNguyen updateTaiNguyen(TaiNguyen taiNguyen, boolean merge)
		throws SystemException {
		taiNguyen.setNew(false);

		taiNguyen = taiNguyenPersistence.update(taiNguyen, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.nsd.model.TaiNguyen",
			taiNguyenLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.nsd.model.TaiNguyen");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = taiNguyenPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TaiNguyenLocalServiceBaseImpl.class);
