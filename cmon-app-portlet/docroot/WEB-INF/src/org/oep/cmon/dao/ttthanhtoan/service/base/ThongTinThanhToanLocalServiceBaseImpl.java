...
/**
 * The base implementation of the thong tin thanh toan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.ttthanhtoan.service.impl.ThongTinThanhToanLocalServiceImpl}.
 * </p>
 *
 * @author Thanhdd
 ...
 * @generated
 */
public abstract class ThongTinThanhToanLocalServiceBaseImpl
	implements ThongTinThanhToanLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.ttthanhtoan.service.ThongTinThanhToanLocalServiceUtil} to access the thong tin thanh toan local service.
	 */
	 ...
	 */
	public ThongTinThanhToan addThongTinThanhToan(
		ThongTinThanhToan thongTinThanhToan) throws SystemException {
		thongTinThanhToan.setNew(true);

		thongTinThanhToan = thongTinThanhToanPersistence.update(thongTinThanhToan,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(thongTinThanhToan);
			}
	 ...
	 */
	public ThongTinThanhToan createThongTinThanhToan(long id) {
		return thongTinThanhToanPersistence.create(id);
	}
	...
	public void deleteThongTinThanhToan(long id)
		...
		ThongTinThanhToan thongTinThanhToan = thongTinThanhToanPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(thongTinThanhToan);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteThongTinThanhToan(ThongTinThanhToan thongTinThanhToan)
		throws SystemException {
		thongTinThanhToanPersistence.remove(thongTinThanhToan);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return thongTinThanhToanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return thongTinThanhToanPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ThongTinThanhToan fetchThongTinThanhToan(long id)
		throws SystemException {
		return thongTinThanhToanPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ThongTinThanhToan getThongTinThanhToan(long id)
		throws PortalException, SystemException {
		return thongTinThanhToanPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return thongTinThanhToanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ThongTinThanhToan> getThongTinThanhToans(int start, int end)
		throws SystemException {
		return thongTinThanhToanPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getThongTinThanhToansCount() throws SystemException {
		return thongTinThanhToanPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ThongTinThanhToan updateThongTinThanhToan(
		ThongTinThanhToan thongTinThanhToan) throws SystemException {
		return updateThongTinThanhToan(thongTinThanhToan, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.ttthanhtoan.model.ThongTinThanhToan",
			thongTinThanhToanLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.ttthanhtoan.model.ThongTinThanhToan");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = thongTinThanhToanPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ThongTinThanhToanLocalServiceBaseImpl.class);
