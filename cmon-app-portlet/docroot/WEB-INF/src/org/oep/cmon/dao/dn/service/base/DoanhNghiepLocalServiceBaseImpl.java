...
/**
 * The base implementation of the doanh nghiep local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.dn.service.impl.DoanhNghiepLocalServiceImpl}.
 * </p>
 *
 * @author Liemnn
 ...
 * @generated
 */
public abstract class DoanhNghiepLocalServiceBaseImpl
	implements DoanhNghiepLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.dn.service.DoanhNghiepLocalServiceUtil} to access the doanh nghiep local service.
	 */
	...
	public DoanhNghiep addDoanhNghiep(DoanhNghiep doanhNghiep)
		...
		doanhNghiep = doanhNghiepPersistence.update(doanhNghiep, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(doanhNghiep);
			}
	...
	public DoanhNghiep createDoanhNghiep(long id) {
		return doanhNghiepPersistence.create(id);
	}
	...
	public void deleteDoanhNghiep(long id)
		...
		DoanhNghiep doanhNghiep = doanhNghiepPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(doanhNghiep);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDoanhNghiep(DoanhNghiep doanhNghiep)
		throws SystemException {
		doanhNghiepPersistence.remove(doanhNghiep);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return doanhNghiepPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return doanhNghiepPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return doanhNghiepPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DoanhNghiep fetchDoanhNghiep(long id) throws SystemException {
		return doanhNghiepPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DoanhNghiep getDoanhNghiep(long id)
		throws PortalException, SystemException {
		return doanhNghiepPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return doanhNghiepPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DoanhNghiep> getDoanhNghieps(int start, int end)
		throws SystemException {
		return doanhNghiepPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDoanhNghiepsCount() throws SystemException {
		return doanhNghiepPersistence.countAll();
	}
	...
	public DoanhNghiep updateDoanhNghiep(DoanhNghiep doanhNghiep)
		throws SystemException {
		return updateDoanhNghiep(doanhNghiep, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DoanhNghiep updateDoanhNghiep(DoanhNghiep doanhNghiep, boolean merge)
		throws SystemException {
		doanhNghiep.setNew(false);

		doanhNghiep = doanhNghiepPersistence.update(doanhNghiep, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.dn.model.DoanhNghiep",
			doanhNghiepLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.dn.model.DoanhNghiep");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = doanhNghiepPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DoanhNghiepLocalServiceBaseImpl.class);
