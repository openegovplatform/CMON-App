...
/**
 * The base implementation of the report tong hop local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.report.service.impl.ReportTongHopLocalServiceImpl}.
 * </p>
 *
 * @author VIENPN
 ...
 * @generated
 */
public abstract class ReportTongHopLocalServiceBaseImpl
	implements ReportTongHopLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.report.service.ReportTongHopLocalServiceUtil} to access the report tong hop local service.
	 */
	 ...
	 */
	public ReportTongHop addReportTongHop(ReportTongHop reportTongHop)
		throws SystemException {
		reportTongHop.setNew(true);

		reportTongHop = reportTongHopPersistence.update(reportTongHop, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(reportTongHop);
			}
	 ...
	 */
	public ReportTongHop createReportTongHop(ReportTongHopPK reportTongHopPK) {
		return reportTongHopPersistence.create(reportTongHopPK);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteReportTongHop(ReportTongHopPK reportTongHopPK)
		throws PortalException, SystemException {
		ReportTongHop reportTongHop = reportTongHopPersistence.remove(reportTongHopPK);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(reportTongHop);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteReportTongHop(ReportTongHop reportTongHop)
		throws SystemException {
		reportTongHopPersistence.remove(reportTongHop);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return reportTongHopPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return reportTongHopPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ReportTongHop fetchReportTongHop(ReportTongHopPK reportTongHopPK)
		throws SystemException {
		return reportTongHopPersistence.fetchByPrimaryKey(reportTongHopPK);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ReportTongHop getReportTongHop(ReportTongHopPK reportTongHopPK)
		throws PortalException, SystemException {
		return reportTongHopPersistence.findByPrimaryKey(reportTongHopPK);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return reportTongHopPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ReportTongHop> getReportTongHops(int start, int end)
		throws SystemException {
		return reportTongHopPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getReportTongHopsCount() throws SystemException {
		return reportTongHopPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ReportTongHop updateReportTongHop(ReportTongHop reportTongHop)
		throws SystemException {
		return updateReportTongHop(reportTongHop, true);
	}
	...
	public ReportTongHop updateReportTongHop(ReportTongHop reportTongHop,
		...
		reportTongHop = reportTongHopPersistence.update(reportTongHop, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.report.model.ReportTongHop",
			reportTongHopLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.report.model.ReportTongHop");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = reportTongHopPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ReportTongHopLocalServiceBaseImpl.class);
