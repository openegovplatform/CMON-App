...
/**
 * The base implementation of the tai nguyen2 vai tro local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.nsd.service.impl.TaiNguyen2VaiTroLocalServiceImpl}.
 * </p>
 *
 * @author Liemnn
 ...
 * @generated
 */
public abstract class TaiNguyen2VaiTroLocalServiceBaseImpl
	implements TaiNguyen2VaiTroLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.nsd.service.TaiNguyen2VaiTroLocalServiceUtil} to access the tai nguyen2 vai tro local service.
	 */
	 ...
	 */
	public TaiNguyen2VaiTro addTaiNguyen2VaiTro(
		TaiNguyen2VaiTro taiNguyen2VaiTro) throws SystemException {
		taiNguyen2VaiTro.setNew(true);

		taiNguyen2VaiTro = taiNguyen2VaiTroPersistence.update(taiNguyen2VaiTro,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(taiNguyen2VaiTro);
			}
	 ...
	 */
	public TaiNguyen2VaiTro createTaiNguyen2VaiTro(long id) {
		return taiNguyen2VaiTroPersistence.create(id);
	}
	...
	public void deleteTaiNguyen2VaiTro(long id)
		...
		TaiNguyen2VaiTro taiNguyen2VaiTro = taiNguyen2VaiTroPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(taiNguyen2VaiTro);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteTaiNguyen2VaiTro(TaiNguyen2VaiTro taiNguyen2VaiTro)
		throws SystemException {
		taiNguyen2VaiTroPersistence.remove(taiNguyen2VaiTro);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return taiNguyen2VaiTroPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return taiNguyen2VaiTroPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TaiNguyen2VaiTro fetchTaiNguyen2VaiTro(long id)
		throws SystemException {
		return taiNguyen2VaiTroPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TaiNguyen2VaiTro getTaiNguyen2VaiTro(long id)
		throws PortalException, SystemException {
		return taiNguyen2VaiTroPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return taiNguyen2VaiTroPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TaiNguyen2VaiTro> getTaiNguyen2VaiTros(int start, int end)
		throws SystemException {
		return taiNguyen2VaiTroPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTaiNguyen2VaiTrosCount() throws SystemException {
		return taiNguyen2VaiTroPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TaiNguyen2VaiTro updateTaiNguyen2VaiTro(
		TaiNguyen2VaiTro taiNguyen2VaiTro) throws SystemException {
		return updateTaiNguyen2VaiTro(taiNguyen2VaiTro, true);
	}
	 ...
	 */
	public TaiNguyen2VaiTro updateTaiNguyen2VaiTro(
		TaiNguyen2VaiTro taiNguyen2VaiTro, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.nsd.model.TaiNguyen2VaiTro",
			taiNguyen2VaiTroLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.nsd.model.TaiNguyen2VaiTro");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = taiNguyen2VaiTroPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TaiNguyen2VaiTroLocalServiceBaseImpl.class);
