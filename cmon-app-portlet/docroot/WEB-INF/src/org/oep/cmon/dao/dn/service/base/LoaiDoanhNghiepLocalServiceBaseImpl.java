...
/**
 * The base implementation of the loai doanh nghiep local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.dn.service.impl.LoaiDoanhNghiepLocalServiceImpl}.
 * </p>
 *
 * @author Liemnn
 * @see org.oep.cmon.dao.dn.service.impl.LoaiDoanhNghiepLocalServiceImpl
 * @see org.oep.cmon.dao.dn.service.LoaiDoanhNghiepLocalServiceUtil
 * @generated
 */
public abstract class LoaiDoanhNghiepLocalServiceBaseImpl
	implements LoaiDoanhNghiepLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.dn.service.LoaiDoanhNghiepLocalServiceUtil} to access the loai doanh nghiep local service.
	 */
	 ...
	 */
	public LoaiDoanhNghiep addLoaiDoanhNghiep(LoaiDoanhNghiep loaiDoanhNghiep)
		throws SystemException {
		loaiDoanhNghiep.setNew(true);

		loaiDoanhNghiep = loaiDoanhNghiepPersistence.update(loaiDoanhNghiep,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(loaiDoanhNghiep);
			}
	 ...
	 */
	public LoaiDoanhNghiep createLoaiDoanhNghiep(long id) {
		return loaiDoanhNghiepPersistence.create(id);
	}
	...
	public void deleteLoaiDoanhNghiep(long id)
		...
		LoaiDoanhNghiep loaiDoanhNghiep = loaiDoanhNghiepPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(loaiDoanhNghiep);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteLoaiDoanhNghiep(LoaiDoanhNghiep loaiDoanhNghiep)
		throws SystemException {
		loaiDoanhNghiepPersistence.remove(loaiDoanhNghiep);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return loaiDoanhNghiepPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return loaiDoanhNghiepPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public LoaiDoanhNghiep fetchLoaiDoanhNghiep(long id)
		throws SystemException {
		return loaiDoanhNghiepPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LoaiDoanhNghiep getLoaiDoanhNghiep(long id)
		throws PortalException, SystemException {
		return loaiDoanhNghiepPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return loaiDoanhNghiepPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<LoaiDoanhNghiep> getLoaiDoanhNghieps(int start, int end)
		throws SystemException {
		return loaiDoanhNghiepPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getLoaiDoanhNghiepsCount() throws SystemException {
		return loaiDoanhNghiepPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LoaiDoanhNghiep updateLoaiDoanhNghiep(
		LoaiDoanhNghiep loaiDoanhNghiep) throws SystemException {
		return updateLoaiDoanhNghiep(loaiDoanhNghiep, true);
	}
	 ...
	 */
	public LoaiDoanhNghiep updateLoaiDoanhNghiep(
		LoaiDoanhNghiep loaiDoanhNghiep, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.dn.model.LoaiDoanhNghiep",
			loaiDoanhNghiepLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.dn.model.LoaiDoanhNghiep");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = loaiDoanhNghiepPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(LoaiDoanhNghiepLocalServiceBaseImpl.class);
