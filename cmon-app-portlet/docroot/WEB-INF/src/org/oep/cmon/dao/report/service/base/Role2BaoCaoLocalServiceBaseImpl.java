...
/**
 * The base implementation of the role2 bao cao local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.report.service.impl.Role2BaoCaoLocalServiceImpl}.
 * </p>
 *
 * @author VIENPN
 * @see org.oep.cmon.dao.report.service.impl.Role2BaoCaoLocalServiceImpl
 * @see org.oep.cmon.dao.report.service.Role2BaoCaoLocalServiceUtil
 * @generated
 */
public abstract class Role2BaoCaoLocalServiceBaseImpl
	implements Role2BaoCaoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.report.service.Role2BaoCaoLocalServiceUtil} to access the role2 bao cao local service.
	 */
	 ...
	 */
	public Role2BaoCao addRole2BaoCao(Role2BaoCao role2BaoCao)
		throws SystemException {
		role2BaoCao.setNew(true);

		role2BaoCao = role2BaoCaoPersistence.update(role2BaoCao, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(role2BaoCao);
			}
	 ...
	 */
	public Role2BaoCao createRole2BaoCao(long ID) {
		return role2BaoCaoPersistence.create(ID);
	}
	...
	public void deleteRole2BaoCao(long ID)
		...
		Role2BaoCao role2BaoCao = role2BaoCaoPersistence.remove(ID);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(role2BaoCao);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteRole2BaoCao(Role2BaoCao role2BaoCao)
		throws SystemException {
		role2BaoCaoPersistence.remove(role2BaoCao);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return role2BaoCaoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return role2BaoCaoPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return role2BaoCaoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Role2BaoCao fetchRole2BaoCao(long ID) throws SystemException {
		return role2BaoCaoPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Role2BaoCao getRole2BaoCao(long ID)
		throws PortalException, SystemException {
		return role2BaoCaoPersistence.findByPrimaryKey(ID);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return role2BaoCaoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Role2BaoCao> getRole2BaoCaos(int start, int end)
		throws SystemException {
		return role2BaoCaoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getRole2BaoCaosCount() throws SystemException {
		return role2BaoCaoPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Role2BaoCao updateRole2BaoCao(Role2BaoCao role2BaoCao)
		throws SystemException {
		return updateRole2BaoCao(role2BaoCao, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Role2BaoCao updateRole2BaoCao(Role2BaoCao role2BaoCao, boolean merge)
		throws SystemException {
		role2BaoCao.setNew(false);

		role2BaoCao = role2BaoCaoPersistence.update(role2BaoCao, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.report.model.Role2BaoCao",
			role2BaoCaoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.report.model.Role2BaoCao");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = role2BaoCaoPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(Role2BaoCaoLocalServiceBaseImpl.class);
