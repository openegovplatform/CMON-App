...
/**
 * The base implementation of the trinh do hoc van local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.cd.service.impl.TrinhDoHocVanLocalServiceImpl}.
 * </p>
 *
 * @author LIEMNN
 * @see org.oep.cmon.dao.cd.service.impl.TrinhDoHocVanLocalServiceImpl
 * @see org.oep.cmon.dao.cd.service.TrinhDoHocVanLocalServiceUtil
 * @generated
 */
public abstract class TrinhDoHocVanLocalServiceBaseImpl
	implements TrinhDoHocVanLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.cd.service.TrinhDoHocVanLocalServiceUtil} to access the trinh do hoc van local service.
	 */
	 ...
	 */
	public TrinhDoHocVan addTrinhDoHocVan(TrinhDoHocVan trinhDoHocVan)
		throws SystemException {
		trinhDoHocVan.setNew(true);

		trinhDoHocVan = trinhDoHocVanPersistence.update(trinhDoHocVan, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(trinhDoHocVan);
			}
	 ...
	 */
	public TrinhDoHocVan createTrinhDoHocVan(long id) {
		return trinhDoHocVanPersistence.create(id);
	}
	...
	public void deleteTrinhDoHocVan(long id)
		...
		TrinhDoHocVan trinhDoHocVan = trinhDoHocVanPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(trinhDoHocVan);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteTrinhDoHocVan(TrinhDoHocVan trinhDoHocVan)
		throws SystemException {
		trinhDoHocVanPersistence.remove(trinhDoHocVan);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return trinhDoHocVanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trinhDoHocVanPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TrinhDoHocVan fetchTrinhDoHocVan(long id) throws SystemException {
		return trinhDoHocVanPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrinhDoHocVan getTrinhDoHocVan(long id)
		throws PortalException, SystemException {
		return trinhDoHocVanPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trinhDoHocVanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrinhDoHocVan> getTrinhDoHocVans(int start, int end)
		throws SystemException {
		return trinhDoHocVanPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrinhDoHocVansCount() throws SystemException {
		return trinhDoHocVanPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrinhDoHocVan updateTrinhDoHocVan(TrinhDoHocVan trinhDoHocVan)
		throws SystemException {
		return updateTrinhDoHocVan(trinhDoHocVan, true);
	}
	...
	public TrinhDoHocVan updateTrinhDoHocVan(TrinhDoHocVan trinhDoHocVan,
		...
		trinhDoHocVan = trinhDoHocVanPersistence.update(trinhDoHocVan, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.cd.model.TrinhDoHocVan",
			trinhDoHocVanLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.cd.model.TrinhDoHocVan");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trinhDoHocVanPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TrinhDoHocVanLocalServiceBaseImpl.class);
