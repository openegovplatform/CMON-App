...
/**
 * The base implementation of the file dinh kem local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.hosohcc.service.impl.FileDinhKemLocalServiceImpl}.
 * </p>
 *
 * @author LIEMNn
...
public abstract class FileDinhKemLocalServiceBaseImpl
	implements FileDinhKemLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.hosohcc.service.FileDinhKemLocalServiceUtil} to access the file dinh kem local service.
	 */
	...
	public FileDinhKem addFileDinhKem(FileDinhKem fileDinhKem)
		...
		fileDinhKem = fileDinhKemPersistence.update(fileDinhKem, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(fileDinhKem);
			}
	 ...
	 */
	public FileDinhKem createFileDinhKem(long id) {
		return fileDinhKemPersistence.create(id);
	}
	...
	public void deleteFileDinhKem(long id)
		...
		FileDinhKem fileDinhKem = fileDinhKemPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(fileDinhKem);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public FileDinhKem fetchFileDinhKem(long id) throws SystemException {
		return fileDinhKemPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FileDinhKem getFileDinhKem(long id)
		throws PortalException, SystemException {
		return fileDinhKemPersistence.findByPrimaryKey(id);
	}
	...
	public FileDinhKem updateFileDinhKem(FileDinhKem fileDinhKem)
		throws SystemException {
		return updateFileDinhKem(fileDinhKem, true);
	}
	...
	public FileDinhKem updateFileDinhKem(FileDinhKem fileDinhKem, boolean merge)
		...
		fileDinhKem = fileDinhKemPersistence.update(fileDinhKem, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.hosohcc.model.FileDinhKem",
			fileDinhKemLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.hosohcc.model.FileDinhKem");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(FileDinhKemLocalServiceBaseImpl.class);
