...
/**
 * The base implementation of the lephi_chitiet local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.report.service.impl.Lephi_chitietLocalServiceImpl}.
 * </p>
 *
 * @author VIENPN
 ...
 * @generated
 */
public abstract class Lephi_chitietLocalServiceBaseImpl
	implements Lephi_chitietLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.report.service.Lephi_chitietLocalServiceUtil} to access the lephi_chitiet local service.
	 */
	 ...
	 */
	public Lephi_chitiet addLephi_chitiet(Lephi_chitiet lephi_chitiet)
		throws SystemException {
		lephi_chitiet.setNew(true);

		lephi_chitiet = lephi_chitietPersistence.update(lephi_chitiet, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(lephi_chitiet);
			}
	 ...
	 */
	public Lephi_chitiet createLephi_chitiet(long ID) {
		return lephi_chitietPersistence.create(ID);
	}
	...
	public void deleteLephi_chitiet(long ID)
		...
		Lephi_chitiet lephi_chitiet = lephi_chitietPersistence.remove(ID);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(lephi_chitiet);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteLephi_chitiet(Lephi_chitiet lephi_chitiet)
		throws SystemException {
		lephi_chitietPersistence.remove(lephi_chitiet);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return lephi_chitietPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return lephi_chitietPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Lephi_chitiet fetchLephi_chitiet(long ID) throws SystemException {
		return lephi_chitietPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Lephi_chitiet getLephi_chitiet(long ID)
		throws PortalException, SystemException {
		return lephi_chitietPersistence.findByPrimaryKey(ID);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return lephi_chitietPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Lephi_chitiet> getLephi_chitiets(int start, int end)
		throws SystemException {
		return lephi_chitietPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getLephi_chitietsCount() throws SystemException {
		return lephi_chitietPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Lephi_chitiet updateLephi_chitiet(Lephi_chitiet lephi_chitiet)
		throws SystemException {
		return updateLephi_chitiet(lephi_chitiet, true);
	}
	...
	public Lephi_chitiet updateLephi_chitiet(Lephi_chitiet lephi_chitiet,
		...
		lephi_chitiet = lephi_chitietPersistence.update(lephi_chitiet, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.report.model.Lephi_chitiet",
			lephi_chitietLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.report.model.Lephi_chitiet");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = lephi_chitietPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(Lephi_chitietLocalServiceBaseImpl.class);
