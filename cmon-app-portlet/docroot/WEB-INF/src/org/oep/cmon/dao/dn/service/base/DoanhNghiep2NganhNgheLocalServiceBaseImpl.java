...
/**
 * The base implementation of the doanh nghiep2 nganh nghe local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.dn.service.impl.DoanhNghiep2NganhNgheLocalServiceImpl}.
 * </p>
 *
 * @author Liemnn
 * @see org.oep.cmon.dao.dn.service.impl.DoanhNghiep2NganhNgheLocalServiceImpl
 * @see org.oep.cmon.dao.dn.service.DoanhNghiep2NganhNgheLocalServiceUtil
 * @generated
 */
public abstract class DoanhNghiep2NganhNgheLocalServiceBaseImpl
	implements DoanhNghiep2NganhNgheLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.dn.service.DoanhNghiep2NganhNgheLocalServiceUtil} to access the doanh nghiep2 nganh nghe local service.
	 */
	 ...
	 */
	public DoanhNghiep2NganhNghe addDoanhNghiep2NganhNghe(
		DoanhNghiep2NganhNghe doanhNghiep2NganhNghe) throws SystemException {
		doanhNghiep2NganhNghe.setNew(true);

		doanhNghiep2NganhNghe = doanhNghiep2NganhNghePersistence.update(doanhNghiep2NganhNghe,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(doanhNghiep2NganhNghe);
			}
	 ...
	 */
	public DoanhNghiep2NganhNghe createDoanhNghiep2NganhNghe(long id) {
		return doanhNghiep2NganhNghePersistence.create(id);
	}
	...
	public void deleteDoanhNghiep2NganhNghe(long id)
		...
		DoanhNghiep2NganhNghe doanhNghiep2NganhNghe = doanhNghiep2NganhNghePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(doanhNghiep2NganhNghe);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteDoanhNghiep2NganhNghe(
		DoanhNghiep2NganhNghe doanhNghiep2NganhNghe) throws SystemException {
		doanhNghiep2NganhNghePersistence.remove(doanhNghiep2NganhNghe);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return doanhNghiep2NganhNghePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return doanhNghiep2NganhNghePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DoanhNghiep2NganhNghe fetchDoanhNghiep2NganhNghe(long id)
		throws SystemException {
		return doanhNghiep2NganhNghePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DoanhNghiep2NganhNghe getDoanhNghiep2NganhNghe(long id)
		throws PortalException, SystemException {
		return doanhNghiep2NganhNghePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return doanhNghiep2NganhNghePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DoanhNghiep2NganhNghe> getDoanhNghiep2NganhNghes(int start,
		int end) throws SystemException {
		return doanhNghiep2NganhNghePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDoanhNghiep2NganhNghesCount() throws SystemException {
		return doanhNghiep2NganhNghePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DoanhNghiep2NganhNghe updateDoanhNghiep2NganhNghe(
		DoanhNghiep2NganhNghe doanhNghiep2NganhNghe) throws SystemException {
		return updateDoanhNghiep2NganhNghe(doanhNghiep2NganhNghe, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.dn.model.DoanhNghiep2NganhNghe",
			doanhNghiep2NganhNgheLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.dn.model.DoanhNghiep2NganhNghe");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = doanhNghiep2NganhNghePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DoanhNghiep2NganhNgheLocalServiceBaseImpl.class);
