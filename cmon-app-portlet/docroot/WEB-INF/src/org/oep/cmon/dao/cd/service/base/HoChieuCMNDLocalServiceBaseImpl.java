...
/**
 * The base implementation of the ho chieu c m n d local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.cd.service.impl.HoChieuCMNDLocalServiceImpl}.
 * </p>
 *
 * @author LIEMNN
 * @see org.oep.cmon.dao.cd.service.impl.HoChieuCMNDLocalServiceImpl
 * @see org.oep.cmon.dao.cd.service.HoChieuCMNDLocalServiceUtil
 * @generated
 */
public abstract class HoChieuCMNDLocalServiceBaseImpl
	implements HoChieuCMNDLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.cd.service.HoChieuCMNDLocalServiceUtil} to access the ho chieu c m n d local service.
	 */
	 ...
	 */
	public HoChieuCMND addHoChieuCMND(HoChieuCMND hoChieuCMND)
		throws SystemException {
		hoChieuCMND.setNew(true);

		hoChieuCMND = hoChieuCMNDPersistence.update(hoChieuCMND, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(hoChieuCMND);
			}
	 ...
	 */
	public HoChieuCMND createHoChieuCMND(long id) {
		return hoChieuCMNDPersistence.create(id);
	}
	...
	public void deleteHoChieuCMND(long id)
		...
		HoChieuCMND hoChieuCMND = hoChieuCMNDPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(hoChieuCMND);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteHoChieuCMND(HoChieuCMND hoChieuCMND)
		throws SystemException {
		hoChieuCMNDPersistence.remove(hoChieuCMND);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return hoChieuCMNDPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return hoChieuCMNDPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return hoChieuCMNDPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public HoChieuCMND fetchHoChieuCMND(long id) throws SystemException {
		return hoChieuCMNDPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HoChieuCMND getHoChieuCMND(long id)
		throws PortalException, SystemException {
		return hoChieuCMNDPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return hoChieuCMNDPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<HoChieuCMND> getHoChieuCMNDs(int start, int end)
		throws SystemException {
		return hoChieuCMNDPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getHoChieuCMNDsCount() throws SystemException {
		return hoChieuCMNDPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HoChieuCMND updateHoChieuCMND(HoChieuCMND hoChieuCMND)
		throws SystemException {
		return updateHoChieuCMND(hoChieuCMND, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HoChieuCMND updateHoChieuCMND(HoChieuCMND hoChieuCMND, boolean merge)
		throws SystemException {
		hoChieuCMND.setNew(false);

		hoChieuCMND = hoChieuCMNDPersistence.update(hoChieuCMND, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.cd.model.HoChieuCMND",
			hoChieuCMNDLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.cd.model.HoChieuCMND");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = hoChieuCMNDPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(HoChieuCMNDLocalServiceBaseImpl.class);
