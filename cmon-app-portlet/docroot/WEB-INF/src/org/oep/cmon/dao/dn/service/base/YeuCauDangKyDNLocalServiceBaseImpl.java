...
/**
 * The base implementation of the yeu cau dang ky d n local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.dn.service.impl.YeuCauDangKyDNLocalServiceImpl}.
 * </p>
 *
 * @author Liemnn
 * @see org.oep.cmon.dao.dn.service.impl.YeuCauDangKyDNLocalServiceImpl
 * @see org.oep.cmon.dao.dn.service.YeuCauDangKyDNLocalServiceUtil
 * @generated
 */
public abstract class YeuCauDangKyDNLocalServiceBaseImpl
	implements YeuCauDangKyDNLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.dn.service.YeuCauDangKyDNLocalServiceUtil} to access the yeu cau dang ky d n local service.
	 */
	 ...
	 */
	public YeuCauDangKyDN addYeuCauDangKyDN(YeuCauDangKyDN yeuCauDangKyDN)
		throws SystemException {
		yeuCauDangKyDN.setNew(true);

		yeuCauDangKyDN = yeuCauDangKyDNPersistence.update(yeuCauDangKyDN, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(yeuCauDangKyDN);
			}
	 ...
	 */
	public YeuCauDangKyDN createYeuCauDangKyDN(long id) {
		return yeuCauDangKyDNPersistence.create(id);
	}
	...
	public void deleteYeuCauDangKyDN(long id)
		...
		YeuCauDangKyDN yeuCauDangKyDN = yeuCauDangKyDNPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(yeuCauDangKyDN);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteYeuCauDangKyDN(YeuCauDangKyDN yeuCauDangKyDN)
		throws SystemException {
		yeuCauDangKyDNPersistence.remove(yeuCauDangKyDN);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return yeuCauDangKyDNPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return yeuCauDangKyDNPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public YeuCauDangKyDN fetchYeuCauDangKyDN(long id)
		throws SystemException {
		return yeuCauDangKyDNPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public YeuCauDangKyDN getYeuCauDangKyDN(long id)
		throws PortalException, SystemException {
		return yeuCauDangKyDNPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return yeuCauDangKyDNPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<YeuCauDangKyDN> getYeuCauDangKyDNs(int start, int end)
		throws SystemException {
		return yeuCauDangKyDNPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getYeuCauDangKyDNsCount() throws SystemException {
		return yeuCauDangKyDNPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public YeuCauDangKyDN updateYeuCauDangKyDN(YeuCauDangKyDN yeuCauDangKyDN)
		throws SystemException {
		return updateYeuCauDangKyDN(yeuCauDangKyDN, true);
	}
	...
	public YeuCauDangKyDN updateYeuCauDangKyDN(YeuCauDangKyDN yeuCauDangKyDN,
		...
		yeuCauDangKyDN = yeuCauDangKyDNPersistence.update(yeuCauDangKyDN, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.dn.model.YeuCauDangKyDN",
			yeuCauDangKyDNLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.dn.model.YeuCauDangKyDN");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = yeuCauDangKyDNPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(YeuCauDangKyDNLocalServiceBaseImpl.class);
