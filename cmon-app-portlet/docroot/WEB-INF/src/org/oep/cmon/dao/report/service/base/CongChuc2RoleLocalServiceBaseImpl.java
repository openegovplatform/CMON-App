...
/**
 * The base implementation of the cong chuc2 role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.report.service.impl.CongChuc2RoleLocalServiceImpl}.
 * </p>
 *
 * @author VIENPN
 ...
 * @generated
 */
public abstract class CongChuc2RoleLocalServiceBaseImpl
	implements CongChuc2RoleLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.report.service.CongChuc2RoleLocalServiceUtil} to access the cong chuc2 role local service.
	 */
	 ...
	 */
	public CongChuc2Role addCongChuc2Role(CongChuc2Role congChuc2Role)
		throws SystemException {
		congChuc2Role.setNew(true);

		congChuc2Role = congChuc2RolePersistence.update(congChuc2Role, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(congChuc2Role);
			}
	 ...
	 */
	public CongChuc2Role createCongChuc2Role(long ID) {
		return congChuc2RolePersistence.create(ID);
	}
	...
	public void deleteCongChuc2Role(long ID)
		...
		CongChuc2Role congChuc2Role = congChuc2RolePersistence.remove(ID);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(congChuc2Role);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteCongChuc2Role(CongChuc2Role congChuc2Role)
		throws SystemException {
		congChuc2RolePersistence.remove(congChuc2Role);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return congChuc2RolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return congChuc2RolePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CongChuc2Role fetchCongChuc2Role(long ID) throws SystemException {
		return congChuc2RolePersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CongChuc2Role getCongChuc2Role(long ID)
		throws PortalException, SystemException {
		return congChuc2RolePersistence.findByPrimaryKey(ID);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return congChuc2RolePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CongChuc2Role> getCongChuc2Roles(int start, int end)
		throws SystemException {
		return congChuc2RolePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCongChuc2RolesCount() throws SystemException {
		return congChuc2RolePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CongChuc2Role updateCongChuc2Role(CongChuc2Role congChuc2Role)
		throws SystemException {
		return updateCongChuc2Role(congChuc2Role, true);
	}
	...
	public CongChuc2Role updateCongChuc2Role(CongChuc2Role congChuc2Role,
		...
		congChuc2Role = congChuc2RolePersistence.update(congChuc2Role, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.report.model.CongChuc2Role",
			congChuc2RoleLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.report.model.CongChuc2Role");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = congChuc2RolePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(CongChuc2RoleLocalServiceBaseImpl.class);
