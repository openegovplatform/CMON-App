...
/**
 * The base implementation of the danh muc role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.report.service.impl.DanhMucRoleLocalServiceImpl}.
 * </p>
 *
 * @author VIENPN
 * @see org.oep.cmon.dao.report.service.impl.DanhMucRoleLocalServiceImpl
 * @see org.oep.cmon.dao.report.service.DanhMucRoleLocalServiceUtil
 * @generated
 */
public abstract class DanhMucRoleLocalServiceBaseImpl
	implements DanhMucRoleLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.report.service.DanhMucRoleLocalServiceUtil} to access the danh muc role local service.
	 */
	 ...
	 */
	public DanhMucRole addDanhMucRole(DanhMucRole danhMucRole)
		throws SystemException {
		danhMucRole.setNew(true);

		danhMucRole = danhMucRolePersistence.update(danhMucRole, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(danhMucRole);
			}
	 ...
	 */
	public DanhMucRole createDanhMucRole(long ID) {
		return danhMucRolePersistence.create(ID);
	}
	...
	public void deleteDanhMucRole(long ID)
		...
		DanhMucRole danhMucRole = danhMucRolePersistence.remove(ID);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(danhMucRole);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDanhMucRole(DanhMucRole danhMucRole)
		throws SystemException {
		danhMucRolePersistence.remove(danhMucRole);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return danhMucRolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return danhMucRolePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return danhMucRolePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DanhMucRole fetchDanhMucRole(long ID) throws SystemException {
		return danhMucRolePersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DanhMucRole getDanhMucRole(long ID)
		throws PortalException, SystemException {
		return danhMucRolePersistence.findByPrimaryKey(ID);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return danhMucRolePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DanhMucRole> getDanhMucRoles(int start, int end)
		throws SystemException {
		return danhMucRolePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDanhMucRolesCount() throws SystemException {
		return danhMucRolePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DanhMucRole updateDanhMucRole(DanhMucRole danhMucRole)
		throws SystemException {
		return updateDanhMucRole(danhMucRole, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DanhMucRole updateDanhMucRole(DanhMucRole danhMucRole, boolean merge)
		throws SystemException {
		danhMucRole.setNew(false);

		danhMucRole = danhMucRolePersistence.update(danhMucRole, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.report.model.DanhMucRole",
			danhMucRoleLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.report.model.DanhMucRole");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = danhMucRolePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DanhMucRoleLocalServiceBaseImpl.class);
