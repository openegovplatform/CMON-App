...
/**
 * The base implementation of the trang thai ho so local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.hosohcc.service.impl.TrangThaiHoSoLocalServiceImpl}.
 * </p>
 *
 * @author LIEMNn
 ...
 * @generated
 */
public abstract class TrangThaiHoSoLocalServiceBaseImpl
	implements TrangThaiHoSoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.hosohcc.service.TrangThaiHoSoLocalServiceUtil} to access the trang thai ho so local service.
	 */
	 ...
	 */
	public TrangThaiHoSo addTrangThaiHoSo(TrangThaiHoSo trangThaiHoSo)
		throws SystemException {
		trangThaiHoSo.setNew(true);

		trangThaiHoSo = trangThaiHoSoPersistence.update(trangThaiHoSo, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(trangThaiHoSo);
			}
	 ...
	 */
	public TrangThaiHoSo createTrangThaiHoSo(long id) {
		return trangThaiHoSoPersistence.create(id);
	}
	...
	public void deleteTrangThaiHoSo(long id)
		...
		TrangThaiHoSo trangThaiHoSo = trangThaiHoSoPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(trangThaiHoSo);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteTrangThaiHoSo(TrangThaiHoSo trangThaiHoSo)
		throws SystemException {
		trangThaiHoSoPersistence.remove(trangThaiHoSo);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return trangThaiHoSoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trangThaiHoSoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TrangThaiHoSo fetchTrangThaiHoSo(long id) throws SystemException {
		return trangThaiHoSoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrangThaiHoSo getTrangThaiHoSo(long id)
		throws PortalException, SystemException {
		return trangThaiHoSoPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trangThaiHoSoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrangThaiHoSo> getTrangThaiHoSos(int start, int end)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrangThaiHoSosCount() throws SystemException {
		return trangThaiHoSoPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrangThaiHoSo updateTrangThaiHoSo(TrangThaiHoSo trangThaiHoSo)
		throws SystemException {
		return updateTrangThaiHoSo(trangThaiHoSo, true);
	}
	...
	public TrangThaiHoSo updateTrangThaiHoSo(TrangThaiHoSo trangThaiHoSo,
		...
		trangThaiHoSo = trangThaiHoSoPersistence.update(trangThaiHoSo, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.hosohcc.model.TrangThaiHoSo",
			trangThaiHoSoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.hosohcc.model.TrangThaiHoSo");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trangThaiHoSoPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TrangThaiHoSoLocalServiceBaseImpl.class);
