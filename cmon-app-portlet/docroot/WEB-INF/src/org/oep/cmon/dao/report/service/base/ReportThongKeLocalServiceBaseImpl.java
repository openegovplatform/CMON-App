...
/**
 * The base implementation of the report thong ke local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.report.service.impl.ReportThongKeLocalServiceImpl}.
 * </p>
 *
 * @author VIENPN
 ...
 * @generated
 */
public abstract class ReportThongKeLocalServiceBaseImpl
	implements ReportThongKeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.report.service.ReportThongKeLocalServiceUtil} to access the report thong ke local service.
	 */
	 ...
	 */
	public ReportThongKe addReportThongKe(ReportThongKe reportThongKe)
		throws SystemException {
		reportThongKe.setNew(true);

		reportThongKe = reportThongKePersistence.update(reportThongKe, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(reportThongKe);
			}
	 ...
	 */
	public ReportThongKe createReportThongKe(ReportThongKePK reportThongKePK) {
		return reportThongKePersistence.create(reportThongKePK);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteReportThongKe(ReportThongKePK reportThongKePK)
		throws PortalException, SystemException {
		ReportThongKe reportThongKe = reportThongKePersistence.remove(reportThongKePK);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(reportThongKe);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteReportThongKe(ReportThongKe reportThongKe)
		throws SystemException {
		reportThongKePersistence.remove(reportThongKe);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return reportThongKePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return reportThongKePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ReportThongKe fetchReportThongKe(ReportThongKePK reportThongKePK)
		throws SystemException {
		return reportThongKePersistence.fetchByPrimaryKey(reportThongKePK);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ReportThongKe getReportThongKe(ReportThongKePK reportThongKePK)
		throws PortalException, SystemException {
		return reportThongKePersistence.findByPrimaryKey(reportThongKePK);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return reportThongKePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ReportThongKe> getReportThongKes(int start, int end)
		throws SystemException {
		return reportThongKePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getReportThongKesCount() throws SystemException {
		return reportThongKePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ReportThongKe updateReportThongKe(ReportThongKe reportThongKe)
		throws SystemException {
		return updateReportThongKe(reportThongKe, true);
	}
	...
	public ReportThongKe updateReportThongKe(ReportThongKe reportThongKe,
		...
		reportThongKe = reportThongKePersistence.update(reportThongKe, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.report.model.ReportThongKe",
			reportThongKeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.report.model.ReportThongKe");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = reportThongKePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ReportThongKeLocalServiceBaseImpl.class);
