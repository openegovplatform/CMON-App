...
/**
 * The base implementation of the danh muc bao cao local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.report.service.impl.DanhMucBaoCaoLocalServiceImpl}.
 * </p>
 *
 * @author VIENPN
 * @see org.oep.cmon.dao.report.service.impl.DanhMucBaoCaoLocalServiceImpl
 * @see org.oep.cmon.dao.report.service.DanhMucBaoCaoLocalServiceUtil
 * @generated
 */
public abstract class DanhMucBaoCaoLocalServiceBaseImpl
	implements DanhMucBaoCaoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.report.service.DanhMucBaoCaoLocalServiceUtil} to access the danh muc bao cao local service.
	 */
	 ...
	 */
	public DanhMucBaoCao addDanhMucBaoCao(DanhMucBaoCao danhMucBaoCao)
		throws SystemException {
		danhMucBaoCao.setNew(true);

		danhMucBaoCao = danhMucBaoCaoPersistence.update(danhMucBaoCao, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(danhMucBaoCao);
			}
	 ...
	 */
	public DanhMucBaoCao createDanhMucBaoCao(long ID) {
		return danhMucBaoCaoPersistence.create(ID);
	}
	...
	public void deleteDanhMucBaoCao(long ID)
		...
		DanhMucBaoCao danhMucBaoCao = danhMucBaoCaoPersistence.remove(ID);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(danhMucBaoCao);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDanhMucBaoCao(DanhMucBaoCao danhMucBaoCao)
		throws SystemException {
		danhMucBaoCaoPersistence.remove(danhMucBaoCao);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return danhMucBaoCaoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return danhMucBaoCaoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DanhMucBaoCao fetchDanhMucBaoCao(long ID) throws SystemException {
		return danhMucBaoCaoPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DanhMucBaoCao getDanhMucBaoCao(long ID)
		throws PortalException, SystemException {
		return danhMucBaoCaoPersistence.findByPrimaryKey(ID);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return danhMucBaoCaoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DanhMucBaoCao> getDanhMucBaoCaos(int start, int end)
		throws SystemException {
		return danhMucBaoCaoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDanhMucBaoCaosCount() throws SystemException {
		return danhMucBaoCaoPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DanhMucBaoCao updateDanhMucBaoCao(DanhMucBaoCao danhMucBaoCao)
		throws SystemException {
		return updateDanhMucBaoCao(danhMucBaoCao, true);
	}
	...
	public DanhMucBaoCao updateDanhMucBaoCao(DanhMucBaoCao danhMucBaoCao,
		...
		danhMucBaoCao = danhMucBaoCaoPersistence.update(danhMucBaoCao, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.report.model.DanhMucBaoCao",
			danhMucBaoCaoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.report.model.DanhMucBaoCao");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = danhMucBaoCaoPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DanhMucBaoCaoLocalServiceBaseImpl.class);
