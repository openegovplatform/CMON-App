...
/**
 * The base implementation of the trinh do chuyen mon local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.cd.service.impl.TrinhDoChuyenMonLocalServiceImpl}.
 * </p>
 *
 * @author LIEMNN
 * @see org.oep.cmon.dao.cd.service.impl.TrinhDoChuyenMonLocalServiceImpl
 * @see org.oep.cmon.dao.cd.service.TrinhDoChuyenMonLocalServiceUtil
 * @generated
 */
public abstract class TrinhDoChuyenMonLocalServiceBaseImpl
	implements TrinhDoChuyenMonLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.cd.service.TrinhDoChuyenMonLocalServiceUtil} to access the trinh do chuyen mon local service.
	 */
	 ...
	 */
	public TrinhDoChuyenMon addTrinhDoChuyenMon(
		TrinhDoChuyenMon trinhDoChuyenMon) throws SystemException {
		trinhDoChuyenMon.setNew(true);

		trinhDoChuyenMon = trinhDoChuyenMonPersistence.update(trinhDoChuyenMon,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(trinhDoChuyenMon);
			}
	 ...
	 */
	public TrinhDoChuyenMon createTrinhDoChuyenMon(long id) {
		return trinhDoChuyenMonPersistence.create(id);
	}
	...
	public void deleteTrinhDoChuyenMon(long id)
		...
		TrinhDoChuyenMon trinhDoChuyenMon = trinhDoChuyenMonPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(trinhDoChuyenMon);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteTrinhDoChuyenMon(TrinhDoChuyenMon trinhDoChuyenMon)
		throws SystemException {
		trinhDoChuyenMonPersistence.remove(trinhDoChuyenMon);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return trinhDoChuyenMonPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trinhDoChuyenMonPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TrinhDoChuyenMon fetchTrinhDoChuyenMon(long id)
		throws SystemException {
		return trinhDoChuyenMonPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrinhDoChuyenMon getTrinhDoChuyenMon(long id)
		throws PortalException, SystemException {
		return trinhDoChuyenMonPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trinhDoChuyenMonPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrinhDoChuyenMon> getTrinhDoChuyenMons(int start, int end)
		throws SystemException {
		return trinhDoChuyenMonPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrinhDoChuyenMonsCount() throws SystemException {
		return trinhDoChuyenMonPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrinhDoChuyenMon updateTrinhDoChuyenMon(
		TrinhDoChuyenMon trinhDoChuyenMon) throws SystemException {
		return updateTrinhDoChuyenMon(trinhDoChuyenMon, true);
	}
	 ...
	 */
	public TrinhDoChuyenMon updateTrinhDoChuyenMon(
		TrinhDoChuyenMon trinhDoChuyenMon, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.cd.model.TrinhDoChuyenMon",
			trinhDoChuyenMonLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.cd.model.TrinhDoChuyenMon");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trinhDoChuyenMonPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TrinhDoChuyenMonLocalServiceBaseImpl.class);
