...
/**
 * The base implementation of the co quan quan ly2 linh vuc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.report.service.impl.CoQuanQuanLy2LinhVucLocalServiceImpl}.
 * </p>
 *
 * @author VIENPN
 ...
 * @generated
 */
public abstract class CoQuanQuanLy2LinhVucLocalServiceBaseImpl
	implements CoQuanQuanLy2LinhVucLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.report.service.CoQuanQuanLy2LinhVucLocalServiceUtil} to access the co quan quan ly2 linh vuc local service.
	 */
	 ...
	 */
	public CoQuanQuanLy2LinhVuc addCoQuanQuanLy2LinhVuc(
		CoQuanQuanLy2LinhVuc coQuanQuanLy2LinhVuc) throws SystemException {
		coQuanQuanLy2LinhVuc.setNew(true);

		coQuanQuanLy2LinhVuc = coQuanQuanLy2LinhVucPersistence.update(coQuanQuanLy2LinhVuc,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(coQuanQuanLy2LinhVuc);
			}
	 ...
	 */
	public CoQuanQuanLy2LinhVuc createCoQuanQuanLy2LinhVuc(
		long NHOMTHUTUCHANHCHINHID) {
		return coQuanQuanLy2LinhVucPersistence.create(NHOMTHUTUCHANHCHINHID);
	}
	...
	public void deleteCoQuanQuanLy2LinhVuc(long NHOMTHUTUCHANHCHINHID)
		...
		CoQuanQuanLy2LinhVuc coQuanQuanLy2LinhVuc = coQuanQuanLy2LinhVucPersistence.remove(NHOMTHUTUCHANHCHINHID);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(coQuanQuanLy2LinhVuc);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteCoQuanQuanLy2LinhVuc(
		CoQuanQuanLy2LinhVuc coQuanQuanLy2LinhVuc) throws SystemException {
		coQuanQuanLy2LinhVucPersistence.remove(coQuanQuanLy2LinhVuc);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return coQuanQuanLy2LinhVucPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return coQuanQuanLy2LinhVucPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CoQuanQuanLy2LinhVuc fetchCoQuanQuanLy2LinhVuc(
		long NHOMTHUTUCHANHCHINHID) throws SystemException {
		return coQuanQuanLy2LinhVucPersistence.fetchByPrimaryKey(NHOMTHUTUCHANHCHINHID);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CoQuanQuanLy2LinhVuc getCoQuanQuanLy2LinhVuc(
		long NHOMTHUTUCHANHCHINHID) throws PortalException, SystemException {
		return coQuanQuanLy2LinhVucPersistence.findByPrimaryKey(NHOMTHUTUCHANHCHINHID);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return coQuanQuanLy2LinhVucPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CoQuanQuanLy2LinhVuc> getCoQuanQuanLy2LinhVucs(int start,
		int end) throws SystemException {
		return coQuanQuanLy2LinhVucPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCoQuanQuanLy2LinhVucsCount() throws SystemException {
		return coQuanQuanLy2LinhVucPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CoQuanQuanLy2LinhVuc updateCoQuanQuanLy2LinhVuc(
		CoQuanQuanLy2LinhVuc coQuanQuanLy2LinhVuc) throws SystemException {
		return updateCoQuanQuanLy2LinhVuc(coQuanQuanLy2LinhVuc, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.report.model.CoQuanQuanLy2LinhVuc",
			coQuanQuanLy2LinhVucLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.report.model.CoQuanQuanLy2LinhVuc");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = coQuanQuanLy2LinhVucPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(CoQuanQuanLy2LinhVucLocalServiceBaseImpl.class);
