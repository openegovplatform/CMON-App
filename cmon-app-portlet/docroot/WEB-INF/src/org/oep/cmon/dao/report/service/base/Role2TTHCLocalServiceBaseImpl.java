...
/**
 * The base implementation of the role2 t t h c local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.report.service.impl.Role2TTHCLocalServiceImpl}.
 * </p>
 *
 * @author VIENPN
 * @see org.oep.cmon.dao.report.service.impl.Role2TTHCLocalServiceImpl
 * @see org.oep.cmon.dao.report.service.Role2TTHCLocalServiceUtil
 * @generated
 */
public abstract class Role2TTHCLocalServiceBaseImpl
	implements Role2TTHCLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.report.service.Role2TTHCLocalServiceUtil} to access the role2 t t h c local service.
	 */
	 ...
	 */
	public Role2TTHC addRole2TTHC(Role2TTHC role2TTHC)
		throws SystemException {
		role2TTHC.setNew(true);

		role2TTHC = role2TTHCPersistence.update(role2TTHC, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(role2TTHC);
			}
	 ...
	 */
	public Role2TTHC createRole2TTHC(long ID) {
		return role2TTHCPersistence.create(ID);
	}
	...
	public void deleteRole2TTHC(long ID)
		...
		Role2TTHC role2TTHC = role2TTHCPersistence.remove(ID);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(role2TTHC);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteRole2TTHC(Role2TTHC role2TTHC) throws SystemException {
		role2TTHCPersistence.remove(role2TTHC);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return role2TTHCPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return role2TTHCPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return role2TTHCPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Role2TTHC fetchRole2TTHC(long ID) throws SystemException {
		return role2TTHCPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Role2TTHC getRole2TTHC(long ID)
		throws PortalException, SystemException {
		return role2TTHCPersistence.findByPrimaryKey(ID);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return role2TTHCPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Role2TTHC> getRole2TTHCs(int start, int end)
		throws SystemException {
		return role2TTHCPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getRole2TTHCsCount() throws SystemException {
		return role2TTHCPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Role2TTHC updateRole2TTHC(Role2TTHC role2TTHC)
		throws SystemException {
		return updateRole2TTHC(role2TTHC, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Role2TTHC updateRole2TTHC(Role2TTHC role2TTHC, boolean merge)
		throws SystemException {
		role2TTHC.setNew(false);

		role2TTHC = role2TTHCPersistence.update(role2TTHC, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.report.model.Role2TTHC",
			role2TTHCLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.report.model.Role2TTHC");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = role2TTHCPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(Role2TTHCLocalServiceBaseImpl.class);
