...
/**
 * The base implementation of the report tong hop chi tiet local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.report.service.impl.ReportTongHopChiTietLocalServiceImpl}.
 * </p>
 *
 * @author VIENPN
 ...
 * @generated
 */
public abstract class ReportTongHopChiTietLocalServiceBaseImpl
	implements ReportTongHopChiTietLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.report.service.ReportTongHopChiTietLocalServiceUtil} to access the report tong hop chi tiet local service.
	 */
	 ...
	 */
	public ReportTongHopChiTiet addReportTongHopChiTiet(
		ReportTongHopChiTiet reportTongHopChiTiet) throws SystemException {
		reportTongHopChiTiet.setNew(true);

		reportTongHopChiTiet = reportTongHopChiTietPersistence.update(reportTongHopChiTiet,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(reportTongHopChiTiet);
			}
	 ...
	 */
	public ReportTongHopChiTiet createReportTongHopChiTiet(
		ReportTongHopChiTietPK reportTongHopChiTietPK) {
		return reportTongHopChiTietPersistence.create(reportTongHopChiTietPK);
	}
	...
	public void deleteReportTongHopChiTiet(
		...
		ReportTongHopChiTiet reportTongHopChiTiet = reportTongHopChiTietPersistence.remove(reportTongHopChiTietPK);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(reportTongHopChiTiet);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteReportTongHopChiTiet(
		ReportTongHopChiTiet reportTongHopChiTiet) throws SystemException {
		reportTongHopChiTietPersistence.remove(reportTongHopChiTiet);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return reportTongHopChiTietPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return reportTongHopChiTietPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ReportTongHopChiTiet fetchReportTongHopChiTiet(
		ReportTongHopChiTietPK reportTongHopChiTietPK)
		throws SystemException {
		return reportTongHopChiTietPersistence.fetchByPrimaryKey(reportTongHopChiTietPK);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ReportTongHopChiTiet getReportTongHopChiTiet(
		ReportTongHopChiTietPK reportTongHopChiTietPK)
		throws PortalException, SystemException {
		return reportTongHopChiTietPersistence.findByPrimaryKey(reportTongHopChiTietPK);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return reportTongHopChiTietPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ReportTongHopChiTiet> getReportTongHopChiTiets(int start,
		int end) throws SystemException {
		return reportTongHopChiTietPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getReportTongHopChiTietsCount() throws SystemException {
		return reportTongHopChiTietPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ReportTongHopChiTiet updateReportTongHopChiTiet(
		ReportTongHopChiTiet reportTongHopChiTiet) throws SystemException {
		return updateReportTongHopChiTiet(reportTongHopChiTiet, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.report.model.ReportTongHopChiTiet",
			reportTongHopChiTietLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.report.model.ReportTongHopChiTiet");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = reportTongHopChiTietPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ReportTongHopChiTietLocalServiceBaseImpl.class);
