...
/**
 * The base implementation of the lephi_linhvuc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.cmon.dao.report.service.impl.Lephi_linhvucLocalServiceImpl}.
 * </p>
 *
 * @author VIENPN
 ...
 * @generated
 */
public abstract class Lephi_linhvucLocalServiceBaseImpl
	implements Lephi_linhvucLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.cmon.dao.report.service.Lephi_linhvucLocalServiceUtil} to access the lephi_linhvuc local service.
	 */
	 ...
	 */
	public Lephi_linhvuc addLephi_linhvuc(Lephi_linhvuc lephi_linhvuc)
		throws SystemException {
		lephi_linhvuc.setNew(true);

		lephi_linhvuc = lephi_linhvucPersistence.update(lephi_linhvuc, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(lephi_linhvuc);
			}
	 ...
	 */
	public Lephi_linhvuc createLephi_linhvuc(int NHOMTHUTUCHANHCHINHID) {
		return lephi_linhvucPersistence.create(NHOMTHUTUCHANHCHINHID);
	}
	...
	public void deleteLephi_linhvuc(int NHOMTHUTUCHANHCHINHID)
		...
		Lephi_linhvuc lephi_linhvuc = lephi_linhvucPersistence.remove(NHOMTHUTUCHANHCHINHID);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(lephi_linhvuc);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteLephi_linhvuc(Lephi_linhvuc lephi_linhvuc)
		throws SystemException {
		lephi_linhvucPersistence.remove(lephi_linhvuc);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return lephi_linhvucPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return lephi_linhvucPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Lephi_linhvuc fetchLephi_linhvuc(int NHOMTHUTUCHANHCHINHID)
		throws SystemException {
		return lephi_linhvucPersistence.fetchByPrimaryKey(NHOMTHUTUCHANHCHINHID);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Lephi_linhvuc getLephi_linhvuc(int NHOMTHUTUCHANHCHINHID)
		throws PortalException, SystemException {
		return lephi_linhvucPersistence.findByPrimaryKey(NHOMTHUTUCHANHCHINHID);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return lephi_linhvucPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Lephi_linhvuc> getLephi_linhvucs(int start, int end)
		throws SystemException {
		return lephi_linhvucPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getLephi_linhvucsCount() throws SystemException {
		return lephi_linhvucPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Lephi_linhvuc updateLephi_linhvuc(Lephi_linhvuc lephi_linhvuc)
		throws SystemException {
		return updateLephi_linhvuc(lephi_linhvuc, true);
	}
	...
	public Lephi_linhvuc updateLephi_linhvuc(Lephi_linhvuc lephi_linhvuc,
		...
		lephi_linhvuc = lephi_linhvucPersistence.update(lephi_linhvuc, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.cmon.dao.report.model.Lephi_linhvuc",
			lephi_linhvucLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.cmon.dao.report.model.Lephi_linhvuc");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = lephi_linhvucPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(Lephi_linhvucLocalServiceBaseImpl.class);
