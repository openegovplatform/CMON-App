...
/** 
 * This class is LDAP
 * This class used to create an user in LDAP server
 * 
 * 
 * Version: 1.0
 *  
...
public class LDAP {
	...
	public LDAP() throws NamingException, IOException{
		...
		this.lDapServerName = props.getProperty("LDAP_SERVER").trim();
		this.rootDn = props.getProperty("ROOT_DN").trim();
		this.rootPass = props.getProperty("ROOT_PASS").trim();
		this.entryTitle = props.getProperty("ENTRY_TITLE").trim();
	...
	/** 
	 * This is function check user exist by email
	 * 
	 * Version: 1.0
	 *  
	 * History: 
	...
	/** 
	 * This is function delete an entry with a specified mail
	 * 
	 * Version: 1.0
	 *  
	 * History: 
	...
	public void delete(String email) throws NamingException {
		if ( this.isExist(email)) {
			this.ctx.destroySubcontext("mail=" + email +"," + this.rootDn);
		}
	}
	
	
	/** 
	 * This is function search result
	 * 
	 * Version: 1.0
	 *  
	 * History: 
