...
/**
 * The base implementation of the ho so mot cua local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.exch.dao.hoso.service.impl.HoSoMotCuaLocalServiceImpl}.
 * </p>
 *
 * @author NAM
...
public abstract class HoSoMotCuaLocalServiceBaseImpl
	implements HoSoMotCuaLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.exch.dao.hoso.service.HoSoMotCuaLocalServiceUtil} to access the ho so mot cua local service.
	 */
	...
	public HoSoMotCua addHoSoMotCua(HoSoMotCua hoSoMotCua)
		...
		hoSoMotCua = hoSoMotCuaPersistence.update(hoSoMotCua, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(hoSoMotCua);
			}
	 ...
	 */
	public HoSoMotCua createHoSoMotCua(long id) {
	...
	public void deleteHoSoMotCua(long id)
		...
		HoSoMotCua hoSoMotCua = hoSoMotCuaPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(hoSoMotCua);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteHoSoMotCua(HoSoMotCua hoSoMotCua)
		throws SystemException {
		hoSoMotCuaPersistence.remove(hoSoMotCua);
	...
	public HoSoMotCua fetchHoSoMotCua(long id) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HoSoMotCua getHoSoMotCua(long id)
		throws PortalException, SystemException {
	...
	public HoSoMotCua updateHoSoMotCua(HoSoMotCua hoSoMotCua)
		throws SystemException {
		return updateHoSoMotCua(hoSoMotCua, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HoSoMotCua updateHoSoMotCua(HoSoMotCua hoSoMotCua, boolean merge)
		throws SystemException {
		hoSoMotCua.setNew(false);

		hoSoMotCua = hoSoMotCuaPersistence.update(hoSoMotCua, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.oep.exch.dao.hoso.model.HoSoMotCua",
			hoSoMotCuaLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.oep.exch.dao.hoso.model.HoSoMotCua");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(HoSoMotCuaLocalServiceBaseImpl.class);
