...
/**
 * The base implementation of the ly do cap doi cap lai g p l x local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.dlms.dao.danhmucgiaypheplaixe.service.impl.LyDoCapDoiCapLaiGPLXLocalServiceImpl}.
 * </p>
 *
 * @author AnhNT
 ...
 * @generated
 */
public abstract class LyDoCapDoiCapLaiGPLXLocalServiceBaseImpl
	implements LyDoCapDoiCapLaiGPLXLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.dlms.dao.danhmucgiaypheplaixe.service.LyDoCapDoiCapLaiGPLXLocalServiceUtil} to access the ly do cap doi cap lai g p l x local service.
	 */
	 ...
	 */
	public LyDoCapDoiCapLaiGPLX addLyDoCapDoiCapLaiGPLX(
		LyDoCapDoiCapLaiGPLX lyDoCapDoiCapLaiGPLX) throws SystemException {
		lyDoCapDoiCapLaiGPLX.setNew(true);

		lyDoCapDoiCapLaiGPLX = lyDoCapDoiCapLaiGPLXPersistence.update(lyDoCapDoiCapLaiGPLX,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(lyDoCapDoiCapLaiGPLX);
			}
	 ...
	 */
	public LyDoCapDoiCapLaiGPLX createLyDoCapDoiCapLaiGPLX(long id) {
		return lyDoCapDoiCapLaiGPLXPersistence.create(id);
	}
	...
	public void deleteLyDoCapDoiCapLaiGPLX(long id)
		...
		LyDoCapDoiCapLaiGPLX lyDoCapDoiCapLaiGPLX = lyDoCapDoiCapLaiGPLXPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(lyDoCapDoiCapLaiGPLX);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteLyDoCapDoiCapLaiGPLX(
		LyDoCapDoiCapLaiGPLX lyDoCapDoiCapLaiGPLX) throws SystemException {
		lyDoCapDoiCapLaiGPLXPersistence.remove(lyDoCapDoiCapLaiGPLX);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return lyDoCapDoiCapLaiGPLXPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return lyDoCapDoiCapLaiGPLXPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public LyDoCapDoiCapLaiGPLX fetchLyDoCapDoiCapLaiGPLX(long id)
		throws SystemException {
		return lyDoCapDoiCapLaiGPLXPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LyDoCapDoiCapLaiGPLX getLyDoCapDoiCapLaiGPLX(long id)
		throws PortalException, SystemException {
		return lyDoCapDoiCapLaiGPLXPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return lyDoCapDoiCapLaiGPLXPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<LyDoCapDoiCapLaiGPLX> getLyDoCapDoiCapLaiGPLXs(int start,
		int end) throws SystemException {
		return lyDoCapDoiCapLaiGPLXPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getLyDoCapDoiCapLaiGPLXsCount() throws SystemException {
		return lyDoCapDoiCapLaiGPLXPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LyDoCapDoiCapLaiGPLX updateLyDoCapDoiCapLaiGPLX(
		LyDoCapDoiCapLaiGPLX lyDoCapDoiCapLaiGPLX) throws SystemException {
		return updateLyDoCapDoiCapLaiGPLX(lyDoCapDoiCapLaiGPLX, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.dlms.dao.danhmucgiaypheplaixe.model.LyDoCapDoiCapLaiGPLX",
			lyDoCapDoiCapLaiGPLXLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = lyDoCapDoiCapLaiGPLXPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(LyDoCapDoiCapLaiGPLXLocalServiceBaseImpl.class);
