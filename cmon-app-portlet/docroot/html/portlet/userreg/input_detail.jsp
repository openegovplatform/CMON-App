 ...
 * limitations under the License.
  -->
<%@page import="org.oep.cmon.user.portlet.util.AuthenticateCodeUtil"%>
...
<portlet:actionURL var="endorse" windowState="normal" name="endorse">
	...
	<portlet:param name="jspPage" value="/html/portlet/userreg/account_creation.jsp"/>
</portlet:actionURL>
<%
		...
		<input type="hidden" name="authCode" value="<%= authCode.toString()%>" />
		  <table cellspacing="0" cellpadding="0" class="egov-table-form">
		   ...
		   <!--  <tr>
		    ...
		    <tr>
		      ...
		      <input name="ten" type="text" id="ten"  maxlength="20" class = "egov-inputfield" value = "<%=userRequest.get("TENCONGDAN")%>" style = 'width:85%'/></td>
		       ...
		       <label class ="egov-label-bold"><liferay-ui:message key="org.oep.cmon.userreg.form.input.ngaySinh" /> <font color = "red">(*)</font></label>
		         <br>
		         <input name="ngaySinh" type="text" id="ngaySinh" class = "egov-calendar   " value = "<%=userRequest.get("NGAYSINH")%>" style = 'width:95%'/>
		    ...
		    <tr>
		    	<td colspan="6">
			    	<label class ="egov-label-bold"><liferay-ui:message key="org.oep.cmon.userreg.form.input.motaThuongTru" /><font color = "red">(*)</font></label>
			    	<br>
			    	 <input name="motaThuongTru" type="text" id="motaThuongTru"  maxlength="100" class = "egov-inputfield" value = "<%=userRequest.get("MOTADIACHITHUONGTRU")%>" style = 'width:95%'/>
