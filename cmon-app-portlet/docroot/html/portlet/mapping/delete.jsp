...
actionUrl.setParameter(ActionRequest.ACTION_NAME, "deleteSynch");
			...
			<tr>
				...
				<td align="left" colspan="2">
					 ...
					 <input type="button" class="egov-button-normal" onclick="synchronizeDNG('true');"
						name="submitButton" value="Chỉ xóa ánh xạ" />
					</span>
					 <span>
					 <input type="button" class="egov-button-normal" onclick="synchronizeDNG('false');"
						name="submitButton" value="Xóa tất dữ liệu" />
					</span>  
...
<script type="text/javascript">
 ...
 function synchronizeDNG(overwrite){
	 ...
	 if(confirm("Bạn chắc chắn muốn thự chiện xóa không ?")){
