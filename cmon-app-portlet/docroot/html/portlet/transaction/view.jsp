...
<div class="wd-main-content.brms">
	<div id="wd-tab-data">
			<%
				if(viewType.equals(TransactionUtils.VIEW_TRANSACTION_DETAILS)) {
			%> 
				<%@include file="/html/portlet/transaction/viewTransactionDetails.jsp"%>
			<%
				} else {
			%>			
					<%@include file="/html/portlet/transaction/viewTransactionList.jsp"%>
			<%	} %>
