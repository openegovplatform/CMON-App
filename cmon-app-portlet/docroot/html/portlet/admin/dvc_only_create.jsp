...
<%
	...
	actionUrl.setParameter(ActionRequest.ACTION_NAME, "addDichVuCongOnly");
	
	Map <String, String> userRequest = (Map <String, String>)renderRequest.getPortletSession().getAttribute("USER_REQUEST_DVC_ONLY_OBJECT");
   	if (userRequest == null) {
   	...
   	renderRequest.getPortletSession().setAttribute("USER_REQUEST_DVC_ONLY_OBJECT", userRequest);
   ...
   <tr>
    ...
    <tr>
  	...
  	<%
  		...
  		redirectUrl.setParameter("jspPage", "/html/portlet/admin/dvc_only_create.jsp");
  	%>
