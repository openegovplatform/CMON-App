...
actionUrl.setParameter(ActionRequest.ACTION_NAME, "searchCongDan");
...
addCongDanRequestUrl.setParameter("jspPage", "/html/portlet/ipmslistportlet/offline/themCongDan.jsp");
...
<div class="egov-container">
	...
	iteratorUrl.setParameter("jspPage", "/html/portlet/ipmslistportlet/offline/timCongDan.jsp");
	...
	<table cellpadding="0" cellspacing="0"  class="egov-table" width="100%">
			...
			<tr>
				...
				<%
				try {
					if (congDan.getDiaChiThuongTruXaId() != null && congDan.getDiaChiThuongTruHuyenId() != null && congDan.getDiaChiThuongTruTinhId() != null) {
					%>
				...
				editRequestUrl.setParameter("jspPage", "/html/portlet/ipmslistportlet/offline/inputHoSo.jsp");
