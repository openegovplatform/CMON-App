...
<%@page import="org.oep.cmon.portlet.doanhnghiep.quanlytaikhoan.business.*"%>
...
iteratorUrl.setParameter("jspPage", "/html/portlet/doanhnghiep/quanlytaikhoan/doanhnghiep/popup_doanhNghiepSearch.jsp");

PortletURL portletUrl = renderResponse.createRenderURL();
portletUrl.setParameter("jspPage", "/html/portlet/doanhnghiep/quanlytaikhoan/doanhnghiep/popup_doanhNghiepSearch.jsp");
...
total = DoanhNghiepBusiness.countDoanhNghiep(searchInputText,Long.valueOf(ThamSoLocalServiceUtil.getValue("LDT_HOKDCATHE")), 0);
listDoanhNghiep = DoanhNghiepBusiness.searchDoanhNghiep(searchInputText,Long.valueOf(ThamSoLocalServiceUtil.getValue("LDT_HOKDCATHE")), 0, searchContainer.getStart(),searchContainer.getEnd());
