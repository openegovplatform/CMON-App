	...
	text-align:center; 	    
					...
					<table id="danhSachThanhVienSangLap" class="taglib-search-iterator egov-table cssTable">
						<thead>							
							<tr>
								<td colspan="8">
									<label class="egov-label-bold" >Danh sách thành viên  </label><label class="egov-label-red">(*)</label>
								</td>
							</tr>
							<tr> 
						...
						<tbody>
							<tr>
								...
								<th width="20%;">CMND/Hộ chiếu</th>
								<th width="20%;">Địa chỉ thường trú</th>
								<th width="20%;">Giá trị góp vốn</th>
								<th width="5%;">Tỷ lệ (%)</th>
								<th width="7%;">Loại thành viên</th>
