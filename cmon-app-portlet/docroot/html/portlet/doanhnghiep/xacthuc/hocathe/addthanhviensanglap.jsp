...
<form method="post" name="frmAddThanhVienSangLap" id="frmAddThanhVienSangLap" action="<%=saveURL%>">
	...
	<table class="egov-table" width="100%" border="0">
		<tbody>
			<tr>
				<td colspan="6">
					<liferay-ui:error key="not.login.error" message = "Bạn không có quyền thực hiện chức năng này!"/>
					<select style="display: none;" id="egov-form-errors">
			      		<option value='tvslTen'><liferay-ui:error key="emptyhoTenNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslTen'><liferay-ui:error key="errorMaxLengTenNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslNgaySinh'><liferay-ui:error key="emptyngaySinhNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslSoCMND'><liferay-ui:error key="errorsoCMNDNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslSoCMND'><liferay-ui:error key="errorsoCMNDNDD9or12" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslSoCMND'><liferay-ui:error key="emptysoCMNDNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslSoCMND'><liferay-ui:error key="notNumberCMNDNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslNgayCapCMND'><liferay-ui:error key="emptyngayCapCMNDNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslTtTinhId'><liferay-ui:error key="emptytinhTTIdNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslTtHuyenId'><liferay-ui:error key="emptyhuyenTTIdNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslTtXaId'><liferay-ui:error key="emptyxaTTIdNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslTtMoTaDiaChi'><liferay-ui:error key="emptymoTaTTNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslTtMoTaDiaChi'><liferay-ui:error key="errorMaxLengmoTaTTNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslCohtTinhId'><liferay-ui:error key="emptytinhHTIdNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslCohtHuyenId'><liferay-ui:error key="emptyhuyenHTIdNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslCohtXaId'><liferay-ui:error key="emptyxaHTIdNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslCohtMoTaChoO'><liferay-ui:error key="emptymoTaHTNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslCohtMoTaChoO'><liferay-ui:error key="errorMaxLengmoTaHTNDD" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslGiaTri'><liferay-ui:error key="emptyGiaTri" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslGiaTri'><liferay-ui:error key="notNumberGiaTri" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslTyLe'><liferay-ui:error key="emptyTyLe" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslTyLe'><liferay-ui:error key="errorMaxLengTyLe" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslTyLe'><liferay-ui:error key="notNumberTyLe" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslLoaiTaiSan'><liferay-ui:error key="emptyLoaiTaiSan" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslLoaiTaiSan'><liferay-ui:error key="errorMaxLengLoaiTaiSan" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslNgayGopVon'><liferay-ui:error key="emptyNgayGopVon" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
			      		<option value='tvslGhiChu'><liferay-ui:error key="errorMaxLengLoaiTaiSan" message = "org.oep.cmon.admin.portlet.cqql.err.empty.ten"/></option>
...
var addThanhVienSangLap = {
	...
	addThanhVienSangLap: function(){
		window.opener.pushDataToDanhSachGopVon({'id':$('input[name=tvslId]').val(),'ten':$('input[name=tvslTen]').val(),'cmnd':$('input[name=tvslSoCMND]').val(),'diachi':$('input[name=tvslTtMoTaDiaChi]').val(),'giatri':$('input[name=tvslGiaTri]').val(),'tyle':$('input[name=tvslTyLe]').val()});
	}
};
