...
<form method="post" name="frmXacThucHoCaTheMotThanhVien" id="frmXacThucHoCaTheMotThanhVien">
	<table class="egov-table">
		...
		<tbody>
			...
			<div>
			<jsp:include page="../quanlydoanhnghiep/quanLyCtyTNHH2TV.jsp"/>
			...
			<jsp:include page="../quanlydoanhnghiep/quanLyCtyHopDanh.jsp"/>
			...
			<jsp:include page="../quanlydoanhnghiep/quanLyCtyCoPhan.jsp"/>
			...
			<jsp:include page="../quanlydoanhnghiep/quanLyCtyTNHH1TV.jsp"/>
